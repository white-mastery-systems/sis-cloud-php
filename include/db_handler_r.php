...
//                    "sub_category" => $jsonData['sub_category']
    ...
    public function internalMailer($getData)
    {
        ...
        if($validate)
        {
            ...
            $imapStream = imap_open("{mail.ezveb.com:143}", $validate['mail_id'], $validate['mail_pwd']);
            imap_append($imapStream, "{mail.ezveb.com:143}Sent Items", $mail->getSentMIMEMessage(), "\\Seen");  
