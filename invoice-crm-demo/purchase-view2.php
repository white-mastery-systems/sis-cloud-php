...
echo "<tr>";
echo "<td colspan='4' class='lightwhite strong ash-text'></td>";
echo "<td class='lightwhite strong ash-text'>Grand Total</td>";
echo "<td class='lightwhite strong ash-text'>".moneyFormatIndia($subtotal)."</td>";
echo "</tr>";
echo "</tbody>";
echo "</table>";
echo "</div>";
