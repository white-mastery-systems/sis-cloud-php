          ...
          <div class="container-title">
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <div  style="position:relative; top:45px;width:auto" class="right rightspace"><span><a class="btn-floating btn-large waves-effect waves-light" title="Delete" id="AdvancedOption" style="display:none" > <i class="material-icons" title="Cancel">delete</i></a></span> <span><a class="btn-floating btn-large waves-effect waves-light" title="New Purchase"><img src="images/cart-plus.png" /></a></span>  <span><a class="btn-floating btn-large waves-effect waves-light" title="Add Vendor"><img src="images/addvendor_small.png" /></a></span> <span><a class="btn-floating btn-large waves-effect waves-light" title="New Products"><img src="images/products_addmall.png" /></a></span> </div>
              </div>
            </div>
          </div>
        </div>
...
$result = mysql_query("SELECT * FROM  purchase_master where status='open' ORDER BY po_no DESC",$conn);
  ...
  ?>
    ...
    <label for="<?php echo $row['p_id']; ?>"></label></td>
          ...
          <td><a href="#" id="<?php echo $row['po_no'];?>" onClick="viewpo(<?php echo $row['po_no'];?>)" rel="ajax">View PO</a></td>
          <td class=""><div class="textalignright" style="width:60%"><?php  echo $row['subtotal']; ?></div></td>
          <td ><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="duplicate">content_copy</a></i></div>  <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="Print">print</a></i></div><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="Email">email</a></i></div><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny" title="Cancel"><a href="#">delete</a></i></div> <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="PDF">picture_as_pdf</a></i></div></div></td>
        </tr>
        <?php
}
?>            
