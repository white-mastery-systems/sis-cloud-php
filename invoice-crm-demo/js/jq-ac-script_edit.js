...
$(document).ready(function(){
    ...
    var rowTemp = [
		...
		'<td class="datagrid-body">&nbsp;</td>',
         '<td class="datagrid-body"><a id="deleteRow"><img src="images/icon-minus.png" alt="Remove Item" title="Remove Item"></a> &nbsp; <input name="itemDesc[]" value="" id="itemDesc" /></td>',
 '<td class="datagrid-body"><input name="itemQty[]" value="" class="quantity textbox" id="itemQty" tabindex="1"/></td>',
            '<td class="datagrid-body"><input name="itemPrice[]" value="" class="textbox rate" id="itemPrice" tabindex="2" /></td>',
     		'<td class="datagrid-body"><input name="itemVat[]" class="textbox itemVat" id="itemVat" type="text" tabindex="3"> </td>',
			 '<td class="datagrid-body"><input name="itemLineTotal[]" class="textbox totalLinePrice" id="itemLineTotal" readonly="readonly" type="text" style="border:none" tabindex="4"/></td>',
			 '  <td class="datagrid-body"></td>',
        '</tr>'
    ].join('');

    // Add row to list and allow user to use autocomplete to find items.
    $("#itemVat").bind('change',function(){
