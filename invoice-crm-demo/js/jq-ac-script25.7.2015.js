...
$(document).ready(function(){
  ...
  $itemrow.find('#sub_catname').val(ui.item.sub_catname);
    ...
    // Format the list menu output of the autocomplete
        ...
        return $( "<li></li>" )
            ...
            .append( "<a>" + item.itemDesc + "---" + item.cat_name + "</a>" )
            .appendTo( ul );
    };
    ...
    var rowTemp = [
		...
		'<td class="datagrid-body">&nbsp;</td>',
         '<td class="datagrid-body"><a id="deleteRow"><span id="img"></span></a> &nbsp; <input name="itemDesc[]" value="" id="itemDesc" class="textbox2"  /></td>',
 '<td class="datagrid-body"><input name="itemQty[]" value="" class="quantity textbox" id="itemQty" tabindex="1" type="number"/></td>',
  ...
  // alert($(this).val());
		...
		$('.item-row:last', $itemsTable).find('#input').rules('remove','required');;
