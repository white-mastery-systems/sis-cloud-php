...
$(document).ready(function(){
        ...
        select: function(event, ui) {
            var $itemrow = $(this).closest('tr');
                    ...
                    $itemrow.find('#itemDesc').val(ui.item.itemDesc);
					  $itemrow.find('#itemQty').val(1);
                    $itemrow.find('#itemPrice').val(ui.item.itemPrice);
                     $itemrow.find('#itemVat').val(0);
    ...
    // Format the list menu output of the autocomplete
        ...
        return $( "<li></li>" )
            ...
            .append( "<a>" + item.itemDesc +"-"+item.itemVat+ "</a>" )
            .appendTo( ul );
    };
    ...
    var rowTemp = [
		...
		'<td class="datagrid-body">&nbsp;</td>',
         '<td class="datagrid-body"><a id="deleteRow"><img src="images/icon-minus.png" alt="Remove Item" title="Remove Item"></a> &nbsp; <input name="itemDesc[]" value="" id="itemDesc" required  class="textbox2"/></td>',
 '<td class="datagrid-body"><input name="itemQty[]" value="0" class="quantity textbox" id="itemQty" tabindex="1" type="text" pattern="[0-9]*" required /></td>',
            '<td class="datagrid-body"><input name="itemPrice[]" value="" class="textbox rate" id="itemPrice" type="text" pattern="[0-9]*" value="0" required  /></td>',
     		'<td class="datagrid-body"><input name="itemVat[]" class="textbox itemVat" id="itemVat" type="text" type="text" value="0"  pattern="[0-9]*" required > </td>',
			 '<td class="datagrid-body"><input name="itemLineTotal[]" class="textbox totalLinePrice" id="itemLineTotal" readonly="readonly" type="text"/></td>',
			 '  <td class="datagrid-body"></td>',
        '</tr>'
    ].join('');
