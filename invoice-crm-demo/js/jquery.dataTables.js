...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append( $('<label style="display:inline;"/>' ).append( str ) );
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<select class="selectbox" style=""/>', {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 *    } );
				 */
				"sNext": "<i class='material-icons' style='position:relative; top:12px; font-size:30px;'>keyboard_arrow_right</i>",
				 ...
				 *    } );
				 */
				"sPrevious": "<i class='material-icons' style='position:relative; top:12px; right:20px; font-size:30px;'>keyboard_arrow_left</i>"
			},
			 ...
			 *    } );
			 */
			"sInfo": "<div class='dat-info'>Showing _START_ to _END_ of _TOTAL_ Entries</div>",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "<div class='dat-info'>Showing 0 to 0 of 0 entries</div>",
