...
function calculatevat(){
	...
	if(vat != '' && typeof(vat) != "undefined" ){
			taxAmount1 = basictotal * ( parseFloat(vat) /100 );
		$('#taxAmount1').val(taxAmount1.toFixed(2));
	
		
		
		
		amountDue1 = parseFloat(basictotal) + parseFloat( taxAmount1 ) + parseFloat( taxAmount );
		totaltax = parseFloat(subTotal) + parseFloat( taxAmount1 ) + parseFloat( taxAmount ) ;
		...
		$('#taxAmount1').val(0);
		amountDue1 = parseFloat(basictotal) + parseFloat( taxAmount );
		totaltax = parseFloat(subTotal) + parseFloat( taxAmount ) ;
...
function calculateAmountDue(){
	...
	if(amountPaid != '' && typeof(amountPaid) != "undefined" ){
		amountDue1 = parseFloat(basictotal) + parseFloat( amountPaid ) + parseFloat( taxAmount );
		totaltax = parseFloat(subTotal) + parseFloat( amountPaid ) + parseFloat( taxAmount ) ;
