...
$result1 = mysql_query("SELECT * FROM  purchase_master where  po_year='".$po_year."' and  po_no='" .$po_no."' and gst_status='included'",$conn);
...
$html.= "<b>F/PUR/SIS-PO/".$projectsingle."/GST/".$po_no. "/". $curYear."-".$nexYear."</b><br />";
$html.= "<b>To:</b><br />";
...
else if( $row['project_name'] == 'S.I.S Luxor' )
{
...
$html.= "</br>&nbsp;";
$html.= "<table  cellpadding='0' cellspacing='0'  width='100%'  id='itemsTable' border='0' style='border-collapse: collapse; border: 1px solid black; font-size:18px; font-family:cambria' >";
$html.= "<thead>";
$html.= "<tr>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px; width:20px; font-size:18px; font-family:cambria' align='center'><b>No</b></th>";
if($row1['folder'] == 'Switches')
{
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:80px; font-size:18px; font-family:cambria' align='center'><b>Code</b></th>";
}
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:310px; font-size:18px; font-family:cambria' align='left'><b>Description</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000; padding:5px; width:100px; font-size:18px; font-family:cambria' align='center'><b>Qty</b></th>";

$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:100px; font-size:18px; font-family:cambria' align='center'><b>Rate <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:10px;width:100px; font-size:18px; font-family:cambria' align='center'><b>Amount <span><img src='images/rupee.jpg' /> </span> </b><br></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:100px; font-size:18px; font-family:cambria' align='center'><b>Tax <span> % </span> </b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:100px; font-size:18px; font-family:cambria' align='center'><b>CGST <span><img src='images/rupee.jpg' /></span></b><br></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:100px; font-size:18px; font-family:cambria' align='center'><b>SGST <span><img src='images/rupee.jpg' /></span></b><br></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:140px; font-size:18px; font-family:cambria' align='right' ><b>Total <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "</tr>";
$html.= "</thead>";
$html.= "<tbody>";
$result_r = mysql_query("SELECT * FROM  purchaseorder_tbl where  po_year='".$po_year."' and  Po_no='".$po_no."' and gst_status='included'",$conn);
while($row = mysql_fetch_array($result_r))
 {
    ...
    $itemtotalamount = $row['itemtotalamount'];
    $vatamount = $row['vatamount'];
		$n+=1;
    $vatamount1 = $vatamount/2; 
$html.= "<tr>";                
$html.= "<tr><td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='center'>".$n."</td>";
if($row1['folder'] == 'Switches')
{
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding:5px; font-size:18px; font-family:cambria' align='left' valign='middle'>" .$product_code. "</td>";
 }
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='left' valign='middle'>" .$productname. "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding:5px; font-size:18px; font-family:cambria' align='center'   >" .$product_qty. " &nbsp; ".$units."</td>";

$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='center'  > " .formatInIndianStyle($ratesperproduct). "</td>";
    
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='center'  > " .formatInIndianStyle($itemtotalamount). "</td>";

$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding:5px; font-size:18px; font-family:cambria' align='center'>" .$vat. "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='center'  > " .formatInIndianStyle($vatamount1). "</td>";
 $html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='center'  > " .formatInIndianStyle($vatamount1). "</td>";   
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-size:18px; font-family:cambria' align='right' > " .formatInIndianStyle($Amount). "</td>";
$html.= "</tr>";
 }
...
$html.= "<td class='cyan white-text'  colspan='2'  align='center' style='border-collapse: collapse;font-size:18px; border:solid 1px #000;padding:5px'><b>Sub Total </b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px; font-size:18px; font-family:cambria' align='right'><b><span><img src='images/rupee.jpg' /> </span> ".formatInIndianStyle($subtotal ).$tpstatus."</b></td>";
$html.= "</tr>";     
...
$html.= "<td class='cyan white-text'  colspan='2'  align='center' style='border-collapse: collapse;font-size:18px; border:solid 1px #000;padding:5px'><b>	Loading and Unloading Transport</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px; font-size:18px; font-family:cambria' align='right'><b><span><img src='images/rupee.jpg' /> </span> ".formatInIndianStyle($tp )."</b></td>";
$html.= "</tr>";
...
$html.= "<td class='cyan white-text'  colspan='2'  align='center' style='border-collapse: collapse;font-size:18px; border:solid 1px #000;padding:5px'><b>Transport Tax</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px; font-size:18px; font-family:cambria' align='right'><b>".$tptax."%</b></td>";
$html.= "</tr>";       
      }
...
$html.= "<td class='cyan white-text'  colspan='2'  align='center' style='border-collapse: collapse; font-size:18px;border:solid 1px #000;padding:5px'><b>Grand Total</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px; font-size:18px; font-family:cambria' align='right'><b><span><img src='images/rupee.jpg' /> </span> ".formatInIndianStyle($grandtotal)."</b></td>";
$html.= "</tr>";        
   }
    else
    {
...
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td valign='top'>Our GSTIN</td>";
$html.= "<td>:</td>";
$html.= "<td>".$ogstin."</td>";
$html.= "<td></td>";
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td valign='top'>Party GSTIN</td>";
$html.= "<td>:</td>";
$html.= "<td>".$pgstin."</td>";
$html.= "</tr>";
$html.= "<tr>";
...
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td valign='top'>Loading & Transport </td>";
$html.= "<td>:</td>";
$html.= "<td>".$vat_o."</td>";
$html.= "</tr>";

$html.= "<tr><td colspan='3'><b>Please Supply by " .$ddate. " at our ".$place;
if($project_name != 'Head Office')
{
$html.= "Site.";
}
...
$html.= "</b></td></tr>";
$html.= "<tr><td colspan='3'><b>Note: Kindly Attach Copy of the PO Along with your Invoice for Payment Purpose</b></td></tr>";  
...
$html.= "<tr>";
$html.= "<td style='width:38%' valign='top'><b>Site contact Person </b></td>";
$html.= "<td style='width:5%'>:</td>";
$html.= "<td style='width:30%'><b>".$contactname."</b></td>";
$html.= "<td  style='width:5%'>:</td>";
$html.= "<td  style='width:22%'><b>".$mobileno."</b></td>";
$html.= "</tr>";
$html.= "<tr>";
...
<img src='images/anandhi_digisign.jpg'  />
</div>
</div>
</div>
</div></div>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px' align='right'><div class='input-field col s9'> <span><img src='images/rupee.jpg' /> </span>  ". formatInIndianStyle($subtotal)."</div></td>";	
$html.= "</tr>";
...
$html.= "<thead>";
$html.=  "<tr>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:40px; height:30px' align='center'><b>No</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000; width:180px; height:30px; padding-left:5px' align='center'><b>Description</b></th>";
$html.=  "<th style='border-collapse: collapse; border:solid 1px #000;width:100px; height:30px' align='center'><b>Detail</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:80px; height:30px' align='center'><b>Tonnage</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:140px; height:30px' align='center'><b>Rate per ton in <span><img src='images/rupee.jpg' /> </span> </b></th>";
if($inclusive != '0')
{
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:70px' align='center'><b>Vat in %</b></th>";
}
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:100px' align='center'><b>Make</b></th>";

$html.= "<th style='border-collapse: collapse; border:solid 1px #000; padding-right:5px;width:185px' align='right'><b>Total in <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "</tr>";
$html.= "</thead>";
$html.= "<tbody>";
$result_r = mysql_query("SELECT * FROM  purchaseorder_tbl where  po_year='".$po_year."' and  Po_no=" .$po_no,$conn);
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;' align='center'>" .$details. "</td>";
...
$html.=  "<td style='border-collapse: collapse; border:solid 1px #000;' align='center'>" .$brand. "</td>";
...
$html.= "<td  style='border-collapse: collapse; border:solid 1px #000; padding-right:5px' align='right'> <span><img src='images/rupee.jpg' /> </span> ".formatInIndianStyle($subtotal)."</td>";
$html.= "</tr>";
$html.= "</tbody>";
$html.=  "</table>";
...
$html.= "<thead>";
$html.= "<tr>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:25px; height:28px;' align='center' valign='middle'><b>SNo</b></th>";
...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:140px; height:28px' align='center' valign='middle'><b>Size</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:80px ; height:28px' align='center' valign='middle'><b>Qty</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:100px ; height:28px' align='center' valign='middle'><b>CFT</b></th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:100px ; height:28px' align='center' valign='middle'><b>Price per CFT</b> </th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000; padding-right:5px;width:170px' align='right' valign='middle'><b>Total in <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "</tr>";$html.= "</thead>";
$html.= "<tbody>";
$result_r = mysql_query("SELECT * FROM  purchaseorder_tbl where  po_year='".$po_year."' and  Po_no='" .$po_no."' and gst_status='included'",$conn);
while($row = mysql_fetch_array($result_r))
 {
	...
	$n+=1;
$html.= "<tr>";                
$html.= "<tr><td style='border-collapse: collapse; border:solid 1px #000;' align='center' valign='middle'>".$n."</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;padding-left:5px 'align='left' valign='middle'>" .trim($productname). "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'>" .$size. "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'>" .$product_qty1. "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'>" .$product_qty. "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle' valign='middle'> " .formatInIndianStyle($ratesperproduct). "</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>" .formatInIndianStyle($Amount). "</td>";
$html.= "</tr>";
 }
$html.= "<tr>";
$html.= "<td colspan='5'  style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'><b>SubTotal</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>".formatInIndianStyle($stotal)."</td>";
$html.= "</tr>";
$html.= "<tr>";
$taxc = ($tax / 100) * $stotal;
    $gstamount = $subtotal - $stotal; 
    $gst = $gstamount/2;
    $gstper = $tax/2;
    
$html.= "<td colspan='5'  ></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'><b>CGST</b> &nbsp; <b>".$gstper."%</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>".formatInIndianStyle($gst)."</td>";
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td colspan='5'  ></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'><b>SGST</b> &nbsp; <b>".$gstper."%</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>".formatInIndianStyle($gst)."</td>";
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td colspan='5' style='border-collapse: collapse; border:solid 1px #000; ' valign='middle'></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'><b>Grand Total</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>".formatInIndianStyle($subtotal)."</td>";
$html.= "</tr>";
$html.= "</tbody>";
$html.=  "</table>";
