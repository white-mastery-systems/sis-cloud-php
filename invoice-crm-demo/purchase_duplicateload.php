...
echo "<input type='hidden' name='po_year' id='po_year'  placeholder='Date' value='".$po_year1."' readonly />";
if($type == "standard")
{
echo "<div class='row topspacelarge' align='center'>";
echo "<div class='col s4 leftspace'  style='display:none'>";
...
echo "</div></div>";
 ...
 echo "<div class='col s12 m6 l6'><div class='input-field col s3 right rightspace'><input type='text' name='po_date' id='po_date'  placeholder='Date' value='".date('d.m.Y')."' /> <input type='hidden' name='type' id='type'  placeholder='Date' value='".$type."' /> </div></div></div></div>";
 echo "<div class='row'>";
 ...
 $result2 = mysql_query("SELECT * FROM  vendor_tbl where ven_compname='" .$ven_id."'",$conn);
...
<div class='col12 s12 m6 l3'>
<div class='col s1'  style='width:auto; margin:0 8px 0 0px'>Ref:</div><div class='input-field col s2 left' style='margin:0 0px 0 10px'><input type='text' name='refno' id='refno' class='validate resetThis' placeholder='Ref No' value='".$refno."'></div> <div  class='col s4' style='width:auto; margin:0 10px 0 8px'> - Dated on</div> <div class='input-field col s2 left'> <input type='text' name='refdate' id='refdate' placeholder='Ref Date' class='validate resetThis'  value='".$refdate."' > </div>";
...
echo "<div class='row  leftspace'><div class='col s2'  style='width:auto; margin:0 8px 0 0px'> Sub : </div><div class='input-field col s3 left'> <input type='text' name='subject' id='subject' class='validate resetThis' placeholder='Subject' required='required' value='".$subject."' ></div> <div class='col s2'  style='width:auto; margin:0 8px 0 0px'>.</div> </div>";
 ...
 echo "<div class='row  leftspace'>
<div class='col s8 left' style='width:auto; margin-right:10px'>We are pleased to place the Purchase order as per the details mentioned below for our Project</div> <div class='col s2 left' ><select name='project_name' id='project_name' onChange='projectlist(this.value)' required='required' class='resetThis'>";
...
while($row = mysql_fetch_array($result_r))
 {
	...
	$n=$n+1;
echo "<tr>";
echo "<td><input type='checkbox' id='selecttd1".$n."'  class='case' /><label for='selecttd1".$n."'></label></td>";
...
echo "</span></div>";
echo "<div class='row'><div class='col s2'>Tin No </div> <div class='input-field col s2 left'><input type='text' name='tinno' id='tinno'  class='resetThis' style='width:auto' placeholder='Tin No' readonly value='".$tinno."' required='required'/> </div></div>";	
echo "<div class='row'><div class='col s2'>CST No </div><div class='input-field col s2 left'><input type='text' name='cstno' id='cstno'  class='resetThis' style='width:auto' placeholder='CST No' readonly value='".$cstno."' required='required'/> </div></div>";
...
echo "<div class='row'><div class='col s2'>Loading & Vat</div><div class='resetThis input-field col s2 left'><input type='text' name='vat_o' id='vat_o'   style='width:auto' placeholder='VAT' value='".$vat_o."' required='required' /></div></div>";
echo "<div class='row'><div class='col s2'>Delivery</div><div class='input-field col s2 left'><input type='text' name='place' id='place'   style='width:auto' placeholder='Place' value='".$place."' class='resetThis' required='required' /></div></div>";
...
<span class='add-on'><i class='icon-th'></i></span>  </div> <div class='col s1  textaligncenter'>at our</div><div class='col s2'><input type='text' name='place1' id='place1'  class='resetThis' style='width:auto'  value='".$place."' placeholder='Place' required='required'/> </div> <div class='col s1 textaligncenter'>Site</div></div>";
echo "<div class='row'><div class='col s2'>Transportation </div> <div class='input-field col s2 left'><input type='text' name='tpwords' id='tpwords'  class='resetThis' style='width:auto' placeholder='Transportation' value='" .$tpwords. "' /> </div></div>";
echo "<div class='row'><b> <div class='col s2'>Site contact Person </div><div class='input-field col s2 left'><input type='text' name='contactname' id='contactname'  class='resetThis' style='width:auto' placeholder='Site Person'  value='".$contactname."' required='required' /></div><div class='col s2 textaligncenter'>Mobile :</div><div class='input-field col s2 left'><input type='text' name='mobilno' id='mobilno'  class='resetThis' placeholder='Mobile No'  value='".$mobileno."' required='required' /></div> </b></div>
<div class='row'><div class='input-field col s2'><b>Site address </b></div>";
echo "<div class='input-field col s2 left'><b><input type='text' name='projectname' id='projectname'  class='resetThis' style='width:auto; font-weight:bold' placeholder='Project Name' readonly  value='".$project_name."' required='required' /></b></div></div>";
...
echo "<input type='hidden' name='project_id' id='project_id'  value='".$project_id."' class='resetThis' style='width:auto'/></div></div></p></div>";
...
else if($type == "upvc")
{
	 echo "<div class='row topspacelarge' align='center'>";
  echo "<div class='col s4 leftspace' style='display:none'>";
 echo "<input type='hidden' placeholder='Newstatus' id='newstatus' name='newstatus' class='resetThis' autocomplete='off'value='".$type."' ><br>&nbsp;";
echo "</div>";
echo "<div class='col s4 leftspace'>";
echo "<input type='text' placeholder='Folder' id='folder' name='folder' class='ui-autocomplete-input resetThis'   autocomplete='off' value='".$folder."' required='required'><br>&nbsp;";
echo "</div></div>";
 ...
 echo "<div class='col12 s12 m6 l3'>";
 echo "<div class='col s12 m6 l6'>&nbsp;</div>";
 echo "<div class='col s12 m6 l6'><div class='input-field col s3 right rightspace'><input type='text' name='po_date' id='po_date'  placeholder='Date' value='".date('d.m.Y')."' required='required' /> <input type='hidden' name='type' id='type'  placeholder='Date' value='".$type."' required='required' /> </div></div></div></div>";
 echo "<div class='row'>";
  echo "<div class='col s12 m6 l6'><div class='input-field col s6 left leftspace'><input type='text' name='po_no' id='po_no' readonly  class='validate' > </div></div>";

 echo "<div class='row'>";
 echo "<div class='col12 s12 m6 l3 '>";
 echo "<div class='col s12 leftspace'><b>To</b></div>"; $result2 = mysql_query("SELECT * FROM  vendor_tbl where ven_compname='" .$ven_id."'",$conn);
	if($row2= mysql_fetch_array($result2))
	 {
		$ven_id1 = $row2['ven_id'];
	    $ven_compname = $row2['ven_compname'] ;
...
<input type='text' name='ven_contactperson' id='ven_contactperson' placeholder='Contact Person' value='".$row2['ven_contactperson'] ."' class='resetThis' required='required'/></div>
 ...
 echo "<div class='row leftspace'>
<div class='col12 s12 m6 l3'>
<div class='col s1'  style='width:auto; margin:0 8px 0 0px'>Ref:</div><div class='input-field col s2 left' style='margin:0 0px 0 10px'><input type='text' name='refno' id='refno' class='validate resetThis' placeholder='Ref No' value='".$refno."'/></div> <div  class='col s4' style='width:auto; margin:0 10px 0 8px'> -Amended Qty Without Glass Dated</div> <div class='input-field col s2 left'> <input type='text' name='refdate' id='refdate' placeholder='Ref Date' class='validate resetThis'  value='".$refdate."'> </div>";
...
echo "<div class='col s2 left' >";
echo "<input type='text' name='city' id='city' class='resetThis' style='width:auto' placeholder='city' readonly value='".$city."'/> </div>
...
$productname = $row['product_name'] ;
	...
	$product_code = $row['product_code'];
    	...
    	$n+=1;
echo "<tr><td><input type='checkbox' id='selecttd".$n."'  class='case' /><label for='selecttd".$n."'></label></td>";
echo "<td><div class='input-field col s8 '> <input  data-type='product_code'  id='itemCode_".$n."'   name='itemCode[]' class='autocomplete_txt resetThis'   type='text' required autocomplete='off' placeholder='Code'  value='". $product_code ."' required='required' /><input  id='itemBrand_".$n."'   name='itemBrand[]' class='resetThis' type='hidden' autocomplete='off' required='required' /></div></td>";
...
echo "<td><div class='input-field col s8 '><input data-type='pro_name' name='itemDesc[]'  id='itemDesc_".$n."'  type='text' class='autocomplete_txt'  required tocomplete='off' placeholder='Type'  value=value=".chr(34).htmlspecialchars($productname).chr(34)." class='resetThis' required='required' /></div></td>";
...
echo "<div id='invoice'>";
 ...
 echo "<div class='col12 s12 m6 l3'>";
 echo "<div class='col s12 m6 l6'>&nbsp;</div>";
 echo "<div class='col s12 m6 l6'><div class='input-field col s3 right rightspace'><input type='text' name='po_date' id='po_date'  placeholder='Date' value='".date('d.m.Y')."' /> <input type='hidden' name='type' id='type'  placeholder='Date' value='".$type."' required='required' /> </div></div></div></div>";
 echo "<div class='row'>";
  echo "<div class='col s12 m6 l6'><div class='input-field col s6 left leftspace'><input type='text' name='po_no' id='po_no' readonly  class='validate' > </div></div>";
...
<div class='col s1'  style='width:auto; margin:0 8px 0 0px'>Ref : </div><div class='input-field col s2 left' style='margin:0 0px 0 10px'><input type='text' name='refno' id='refno' class='validate resetThis' placeholder='Ref No' value='".$refno."' ></div> <div  class='col s4' style='width:auto; margin:0 10px 0 8px'> Dated on </div> <div class='input-field col s2 left'> <input type='text' name='refdate' id='refdate' placeholder='Ref Date' class='validate resetThis' class='resetThis' value='".$refdate."'/> </div>";
...
echo "<td><div class='input-field col s8'><input name='details[]'   id='details_".$n."'  type='text'  value='".$details."' placeholder='Details' required='required' /></div></td>";
...
echo "<div class='row'><div class='col s2'>Delivery</div><div class='input-field col s2 left'><input type='text' name='place' id='place'   style='width:auto' placeholder='Place' value='".$place."' class='resetThis' required='required'/></div></div>";
echo "<div class='row'><div class='col s2'>Please Supply by</div> <div class='input-field col s2  date form_date'> <input size='16' type='text' value='".$ddate."' id='ddate' name='ddate' placeholder='Delivery Date'><span class='add-on'><i class='icon-remove'></i></span>
<span class='add-on'><i class='icon-th'></i></span>  </div> <div class='col s1  textaligncenter'>at our</div><div class='col s2'><input type='text' name='place1' id='place1'  class='resetThis' style='width:auto'  value='".$place."' required='required'/> </div> <div class='col s1 textaligncenter'>Site</div></div>";
echo "<div class='row'><div class='col s2'>Transportation </div> <div class='input-field col s2 left'><input type='text' name='tpwords' id='tpwords'  class='resetThis' style='width:auto' placeholder='Transportation' value='" .$tpwords. "' /> </div></div>";
echo "<div class='row'><b> <div class='col s2'>Site contact Person </div><div class='input-field col s2 left'><input type='text' name='contactname' id='contactname'  class='resetThis' style='width:auto' placeholder='Site Person'  value='".$contactname."' required='required'/></div><div class='col s2 textaligncenter'>Mobile :</div><div class='input-field col s2 left'><input type='text' name='mobilno' id='mobilno'  class='resetThis' placeholder='Mobile No'  value='".$mobileno."' required='required'/></div> </b></div>
<div class='row'><div class='input-field col s2'><b>Site address </b></div>";
echo "<div class='input-field col s2 left'><b><input type='text' name='projectname' id='projectname'  class='resetThis' style='width:auto; font-weight:bold' placeholder='Project Name' readonly  value='".$project_name."' required='required' /></b></div></div>";
...
echo "<div id='invoice'>";
 ...
 echo "<div class='col12 s12 m6 l3'>";
 echo "<div class='col s12 m6 l6'>&nbsp;</div>";
 echo "<div class='col s12 m6 l6'><div class='input-field col s3 right rightspace'><input type='text' name='po_date' id='po_date'  placeholder='Date' value='".date('d.m.Y')."' required='required' /> <input type='hidden' name='type' id='type'  placeholder='Date' value='".$type."' /> </div></div></div></div>";
 echo "<div class='row'>";
  echo "<div class='col s12 m6 l6'><div class='input-field col s6 left leftspace'><input type='text' name='po_no' id='po_no' readonly  class='validate' > </div></div>";
...
echo "<td><div class='input-field col s8'><input name='size[]'   id='size_".$n."'  type='text' class='resetThis changesNo_dr'value=".chr(34).htmlspecialchars($size).chr(34)." placeholder='Size' required='required'/></div></td>";
echo "<td><div class='input-field col s8'>
...
echo "<div class='row'><div class='col s2'>Payment </div> <div class='input-field col s2 left'><input type='text' name='payment' id='payment'  class='resetThis' placeholder='Payment' value='".$payment."' required='required'/> </div> </div>";
echo "<div class='row'><div class='col s2'>Loading & Vat</div><div class='resetThis input-field col s2 left'><input type='text' name='vat_o' id='vat_o'   style='width:auto' placeholder='VAT' value='".$vat_o."' required='required' /></div></div>";
echo "<div class='row'><div class='col s2'>Delivery</div><div class='input-field col s2 left'><input type='text' name='place' id='place'   style='width:auto' placeholder='Place' value='".$place."' class='resetThis' placeholder='place' required='required' /></div></div>";
echo "<div class='row'><div class='col s2'>Please Supply by</div><div class='input-field col s2  date form_date'> <input size='16' type='text' value='".$ddate."' id='ddate' name='ddate' placeholder='Delivery Date'><span class='add-on'><i class='icon-remove'></i></span>
<span class='add-on'><i class='icon-th'></i></span></div><div class='col s1 textaligncenter'>at our</div><div class='col s2'><input type='text' name='place1' id='place1'  class='resetThis' style='width:auto'  value='".$place."' required='required'/> </div> <div class='col s1 textaligncenter'>Site</div></div>";
echo "<div class='row'><div class='col s2'>Transportation </div> <div class='input-field col s2 left'><input type='text' name='tpwords' id='tpwords'  class='resetThis' style='width:auto' placeholder='Transportation' value='" .$tpwords. "' /> </div></div>";
echo "<div class='row'><b> <div class='col s2'>Site contact Person </div><div class='input-field col s2 left'><input type='text' name='contactname' id='contactname'  class='resetThis' style='width:auto' placeholder='Site Person'  value='".$contactname."' required='required'/></div><div class='col s2 textaligncenter'>Mobile :</div><div class='input-field col s2 left'><input type='text' name='mobilno' id='mobilno'  class='resetThis' placeholder='Mobile No'  value='".$mobileno."' required='required'/></div> </b></div>
