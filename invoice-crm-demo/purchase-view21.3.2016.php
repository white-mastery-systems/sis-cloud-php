...
echo "<div class='left leftspace navigations'><a href='order.php' class='btn-floating btn-large waves-effect waves-light'><i class='material-icons'>arrow_back</i></a></div>
</div>
</div>
</div>
</div>";
...
echo "<div class='row leftspace lineheight'><b>Sub : &nbsp;</b>Our PO : " .$po_no." for window for our project <b> " .$project_name."&nbsp;&nbsp; Block &nbsp;".$block."</b> at ".$place."&nbsp;".$city." .</div>";
...
{
	echo "<div class='row leftspace lineheight'><b>Sub : &nbsp;</b>Our PO : " .$po_no." for window for our <b> " .$project_name."</b> at &nbsp; " .$place."&nbsp;".$city." .</div>";
echo "<div class='row leftspace lineheight'>We are pleased to place the Purchase order as per the details mentioned below for our Project " ;
