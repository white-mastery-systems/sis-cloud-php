...
// getting total number records without any search
 ...
 $sql = "SELECT invoiceid,invoicenotype,invoiceno,po_year,invoicedate,projectname,block,flatno,floorno,total,lc_amount,taxamount,sgst,cgst,roundtotal,grandtotal,status,emp_name FROM invoicetable where gst_status='".$_GET['action']."' and projectname='".$_GET['projectname']."'";     

$query = mysqli_query( $conn,$sql ) or die("invoice_load.php: get orders");
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = $row['invoicenotype']."<br>".$row['emp_name'];
