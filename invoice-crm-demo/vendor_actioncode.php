...
isset($_POST['v_mobile']) ? $v_mobile = mysql_real_escape_string($_POST['v_mobile']) : $v_mobile = "0";
...
else
{
    ...
    for($i = 0; $i < count($id); $i++){
		echo $i;
		$sql_update = "delete from vendor_tbl where ven_id=$id[$i]";
$result_update = mysql_query($sql_update,$conn);
$n = $n+1;
}
