...
isset($_POST['ogstin']) ? $ogstin = $_POST['ogstin'] : $ogstin = "none";
isset($_POST['pgstin']) ? $pgstin = $_POST['pgstin'] : $pgstin = "none";
isset($_POST['transportstatus']) ? $transportstatus = $_POST['transportstatus'] : $transportstatus = "none";
...
isset($_POST['tptax']) ? $tptax = $_POST['tptax'] : $tptax = "0";
...
isset($_POST['tstatus']) ? $tstatus = $_POST['tstatus'] : $tstatus = "none";
isset($_POST['tpwords']) ? $tpwords = $_POST['tpwords'] : $tpwords = "none";
//isset($_POST['po_year']) ? $po_year = $_POST['po_year'] : $po_year = "none";
isset($_POST['city']) ? $city = $_POST['city'] : $city = "none";
isset($_POST['transportAmount_s']) ? $tpamount = $_POST['transportAmount_s'] : $tpamount = "none";
isset($_POST['grandTotal']) ? $grandTotal = $_POST['grandTotal'] : $grandTotal = "none";
isset($_POST['transporttaxAmount_s']) ? $tptaxamount= $_POST['transporttaxAmount_s'] : $tptaxamount = "none";
...
$itemtotalamount=$_POST['itemtotalamount'][$row];
$itemVat=$_POST['itemVat'][$row];
$itemVatamount=$_POST['itemVatamount'][$row];
...
$itemtotalamount=mysql_real_escape_string($_POST['itemtotalamount'][$row]);
$itemVatamount=mysql_real_escape_string($_POST['itemVatamount'][$row]);    
...
if( $itemDesc != '')
{
$sql = "INSERT INTO purchaseorder_tbl(product_name,product_code,Po_no,product_qty,ratesperproduct,Amount,vat,po_date,cat_name,sub_catname,units,status,stock_received,project_name,block,po_year,vatamount,itemtotalamount,gst_status) VALUES ('$itemDesc','$product_code',$po_no,$itemQty,$itemPrice,'$itemLineTotal','$itemVat','$po_date','$cat_name','$sub_catname','$units','open','0','$project_name','$blockname','$po_year','$itemVatamount','$itemtotalamount','included')";
...
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,block,status,po_no,stock,stock_balance,stk_received,istatus,po_year,gst_status) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','$blockname','invoiceraised',$po_no,$itemQty,$itemQty,'0','intransit','$po_year','included')";
...
{
$sql_ven2 = "update vendor_tbl set ven_compname='$ven_compname',ven_add1='$ven_add',ven_contactperson='$ven_contactperson',pgstin='$pgstin' where ven_compname='$ven_compname'";
$result_ven2 = mysql_query($sql_ven2,$conn);
echo "Updated";	
}
else
{
$sql_ven1 = "INSERT INTO vendor_tbl (ven_compname,ven_add1,ven_contactperson,pgstin) VALUES ('$ven_compname','$ven_add','$ven_contactperson','$pgstin')";
...
$sql1 = "INSERT INTO purchase_master(po_no,po_date,project_id,ven_id,subtotal,ddate,vat,status,project_name,Block,description,type,refno,refdate,folder,payment,subject,contactname,mobileno,tpwords,po_year,place,ogstin,pgstin,tp,tpamount,tstatus,gst_status,tptax,tptaxafteramount,grandtotal) VALUES ('$po_no','$po_date','$project_id','$ven_compname','$subTotal','$ddate','$tax','open','$project_name','$blockname','$desc','$type','$refno','$refdate','$folder','$payment','$subject','$contactname','$mobileno','$tpwords','$po_year','$city','$ogstin','$pgstin','$transportation','$tpamount','$tstatus','included','$tptax','$tptaxamount','$grandTotal')";
...
$desc =  mysql_real_escape_string($desc);
$sql1 = "INSERT INTO purchase_master(po_no,po_date,project_id,ven_id,subtotal,ddate,vat,status,project_name,Block,description,type,refno,refdate,folder,payment,subject,contactname,mobileno,tpwords,po_year,place) VALUES ($po_no,'$po_date',$project_id,'$ven_compname',$subTotal,'$ddate','$tax','open','$project_name','$blockname','$desc','$type','$refno','$refdate','$folder','$payment','$subject','$contactname','$mobileno','$tpwords','$po_year','$city')";
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
}
...
if( $itemDesc != '')
{
$sql = "INSERT INTO purchaseorder_tbl(product_name,Po_no,product_qty,ratesperproduct,Amount,product_code,po_date,cat_name,sub_catname,units,status,product_cft,size,brand,stock_received,project_name,block,po_year,gst_status) VALUES ('$itemDesc','$po_no','$itemQtyd','$itemPrice','$itemLineTotal','$product_code','$po_date','$cat_name','$sub_catname','CFT','open','$itemQty','$size','$brand','0','$project_name','$blockname','$po_year','included')";
$result = mysql_query($sql,$conn);
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,size,brand,project_name,block,status,po_no,stock,stock_balance,stk_received,istatus,po_year,gst_status) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$size','$brand','$project_name','$blockname','invoiceraised',$po_no,$itemQtyd,$itemQtyd,'0','intransit','$po_year','included')";
$result4 = mysql_query($sql4,$conn);
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
$query_run = mysql_query($query,$conn); 	
while ($req_row = mysql_fetch_array($query_run)) 
...
$desc = mysql_real_escape_string($desc);
$sql1 = "INSERT INTO purchase_master(po_no,po_date,project_id,ven_id,subtotal,ddate,vat,status,project_name,Block,description,type,refno,refdate,folder,tax,stotal,payment,subject,contactname,mobileno,tpwords,po_year,place,gst_status,ogstin,pgstin) VALUES($po_no,'$po_date',$project_id,'$ven_compname','$totalAftertax','$ddate','$tax','open','$project_name','$blockname','$desc','$type','$refno','$refdate','$folder','$vat','$subTotal','$payment','$subject','$contactname','$mobileno','$tpwords','$po_year','$city','included','$ogstin','$pgstin')";
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
}
