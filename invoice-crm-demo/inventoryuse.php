...
function fun_edit(str,str1)
{
	  ...
	  document.getElementById("edit-content").innerHTML = str2;
		...
		//alert(str +","+str1);
      xmlhttp.open("GET","inventoryuse_load.php?pro_name="+str+"&project_name="+str1+"&action=edit", true);
      xmlhttp.send();
...
function update()
{
	...
	var sub_catname = document.getElementById("sub_catname").value;
	...
	var stk_used = document.getElementById("stk_used").value;
		var block_name=document.getElementById("blockname").value;
		var stk_received = document.getElementById("stk_received").value;
		
	alert(stock1);
	var stock_used = stock1 + stk_used;
	//alert(stock_used);
		var xmlhttp;
      if (window.XMLHttpRequest)
      {// code for IE7+, Firefox, Chrome, Opera, Safari
	...
	//window.location.replace("inventory_use.php")
...
alert(stock1+"<="+stk_received);

if(stock1 <= stk_received)
{		
 //  xmlhttp.open("GET","inventoryuse_update2.php?pro_name="+pro_name+"&project_name="+project_name+"&stock1="+stock1+"&stock="+stock , true);
	xmlhttp.open("GET","inventoryuse_load.php?pro_name="+pro_name+"&project_name="+project_name+"&stock1="+stock1+"&stock="+stock+"&cat_name="+cat_name+"&sub_catname="+sub_catname+"&brand="+brand+"&flatno="+flatno+"&block_name="+block_name+"&action=update" , true);
    xmlhttp.send();
	return true;
}
else
{
	//alert("Available Product is only"+stock);
	document.getElementById("err-disp").innerHTML="Available Product is only : "+ stk_received;
	return false;
}
}
