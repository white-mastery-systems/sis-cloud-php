...
<body class="loaded" class="no-print">
  <!-- Start Page Loading -->
...
$result = mysql_query("SELECT * FROM  purchase_master where status='open' ORDER BY po_no DESC",$conn);
  ...
  ?>
    ...
    <label for="<?php echo $row['p_id']; ?>"></label></td>
          ...
          <td ><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="duplicate">content_copy</a></i></div>  <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="Print"  id="print_p" onClick="fun_print(<?php echo $row['po_no']?>);" >print</a></i></div><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="Email">email</a></i></div><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny" title="Cancel"><a href="#">delete</a></i></div> <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="PDF" onClick="fun_pdf(<?php echo $row['po_no'] ?>);" >picture_as_pdf</a></i></div></div></td>
        </tr>
        <?php
}
?>            
