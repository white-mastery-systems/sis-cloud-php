  ...
  <div id="main">
    ...
    <div class="wrapper">
	 ...
	 ?>   
      ...
      <!-- START CONTENT -->
      <section id="content" class="ven-section">
      
        <div id="breadcrumbs-wrapper" class=" grey lighten-3">
          <div class="container-title">
            <div class="row">
              <div class="col s12 m12 l12">
              <span id="ven-head" class="right rightspace navigationsbuttons"> <a href="order.php" class="btn btn-success cyan" type="button">Purchase Orders</a> <a href="products.php" class="btn btn-success cyan" type="button">Products</a> </span>
                <h5 id="ven-head" class="breadcrumbs-title">Vendor</h5>
              <div id="ven-head" class='left leftspace navigations'><a href="order.php" class='btn-floating btn-large waves-effect waves-light pink'><i class='material-icons'>arrow_back</i></a></div>
                <div id="ven-headright" class='right rightspace navigations'><span><a class="btn-floating btn-large waves-effect waves-light pink" title="Delete" id="del_all" style="display:none" > <i class="material-icons" title="Cancel">delete</i></a></span> 
 ...
 <div class="modal fade" id="overlayadd" style="">
  ...
  <form id="fm" method="get" novalidate="novalidate" class="fm-add">
        <div>
				...
				<input type='text' name="v_companyname" id="v_companyname1" value="" class="resetThis">
                <input type="hidden" name="action" id="action" value="add" class="textbox resetThis">
			</div>
		<div>
				 <label>Name </label>
				 <input type="text" name="v_name" id="v_name1" value="" class="resetThis">
			 </div>
            <div>
				 <label>Address </label>
				 <input type="text"  name="v_address" id="v_address1" value="" class="resetThis">
			 </div>
			 
			<div>
				 <label>Mobile</label>
				<input type="text" name="v_mobile" id="v_mobile1" value="" class="resetThis">
			</div>
			 <div>
				 <label>Phone</label>
				 <input type="text" name="v_phone" id="v_phone1" value="" class="resetThis">
			 </div>
              <div>
				 <label>Fax</label>
				 <input type="text" name="v_fax" id="v_fax1" value=""class="resetThis">
			 </div>
               <div>
				 <label>Email</label>
				 <input type="text"  name="v_email" id="v_email1" value=""class="resetThis">
			 </div>
        <div align="right" >           
<button type='submit' class='btn-floating btn-medium waves-effect waves-light pink' title='submit'><i class='material-icons'>done</i></button>  <button type='button' id="clear" class='btn-floating btn-medium waves-effect waves-light pink' onClick="popupclose()"><i class='material-icons'>clear</i></button></div>
 ...
 <div class="modal fade" id="overlayedit" style="">
  ...
  <form id="fm" method="get" novalidate="novalidate" class="fm-edit">
       
		<div>
				<label>Vendor Name</label>
				<input type="text"  name="v_companyname" id="v_companyname" value="" class="">
                   <input type="hidden" name="ven_id" id="ven_id" value="" class="" >
                <input type="hidden" name="action" id="action" value="edit" class="">
			</div>
		<div>
				 <label>Name </label>
				 <input type="text" name="v_name" id="v_name" value=""class="" >
			 </div>
            <div>
				 <label>Address </label>
				 <input type="text" name="v_address" id="v_address" value="" class="" >
			 </div>
			 
			<div>
				 <label>Mobile</label>
				<input type="text" name="v_mobile" id="v_mobile" value="" class="" >
			</div>
			 <div>
				 <label>Phone</label>
				 <input type="text" name="v_phone" id="v_phone" value="" class="" >
			 </div>
              <div>
				 <label>Fax</label>
				 <input type="text" name="v_fax" id="v_fax" value=""class="" >
			 </div>
               <div>
				 <label>Email</label>
				 <input type="text" name="v_email" id="v_email" value=""class="" >
			 </div>
...
$(document).ready(function(){
  $.ajaxSetup({
    ...
    error:function(x,e){
        if(x.status==0){
          alertalert('You are offline,please check your connection');
