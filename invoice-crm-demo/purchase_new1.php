...
<div class='col s12 m6 l6'><div class="input-field col s4 right rightspace"><input type="text" name="po_date" id="po_date" readonly  placeholder="Date" value="<?php echo date('d.m.Y'); ?>" /> </div></div>
</div></div>
<!-- Vendor name-->
<div class="row">
<div class='col12 s12 m6 l3 cyan'>
<div class='col s12 m6 l6'><div class="input-field col s5 left leftspace"><input type="text" id="vendor_name" name="vendor_name"  required /> </div></div>
<div class='col s12 m6 l6 right rightspace'><div class="input-field col s4 left leftspace">&nbsp;</div></div>
</div>
</div><input type="hidden" name="ven_id" id="ven_id" placeholder="vendor-id" class="textbox"  /><br />
<div class="row">
<div class='col12 s12 m6 l3 cyan'>
 
 
<div class='col s12 m6 l6'><div class="input-field col s5 left leftspace"><textarea name="ven_add" id="ven_add" value="" ></textarea>
<input type="hidden" name="ven_id" id="Hidden1" placeholder="vendor-id"  /><br /></div></div>
...
<div class="input-field col s2"> 
  <input type="text" name="ven_contactperson" id="ven_contactperson" /></div>
  </center>
  </div>
</div>
...
<div class='row'>
<div class='col s12 m12 l12'>
<table class='table table-full' cellpadding="0" cellspacing="0"  width="100%"  id="itemsTable" border="1" onLoad="showimg()" > 
<thead>
       ...
       <tbody>
                      ...
                      <td>&nbsp;</td>
                    <td><div class="input-field col s1 "><a id="deleteRow"><span id="img"></span></a> &nbsp;</div>
                      <div class="input-field col s8 "> <input  data-type="productName" name="itemDesc[]" class="textbox2 autocomplete_txt itemDesc" id="itemDesc"  type="text"  required /></div></td>
                    <td><div class="input-field col s8 "> <input name="cat_name[]"  class="textbox" id="cat_name" type="hidden"/>
                      <input name="sub_catname[]"  class="textbox" id="sub_catname" type="hidden"/>
                     <input name="brand[]"  class="textbox" id="brand" tabindex="1" type="hidden"  />
                      <input name="product_code[]"  class="textbox" id="product_code"  type="hidden" />
                       <input name="size[]"  class="textbox" id="size" tabindex="1" type="hidden"  />
                
                    <input name="itemQty[]"  class="quantity textbox" id="itemQty" tabindex="1" type="text" required />
                    </div>
                                       </td>
                    <td>
                    <div class="input-field col s8 "> 
                  <input name="itemPrice[]"  class="textbox rate" id="itemPrice" type="number" pattern="[0-9]*" required /></div></td>
 <td class="datagrid-body"><div class="input-field col s8 "> <input name="itemVat[]" class="textbox itemVat" id="itemVat" type="number"  pattern="[0-9]*" required  ></div></td>	
                    <td><div class="input-field col s8 "> <input name="itemLineTotal[]" class="textbox totalLinePrice" id="itemLineTotal" readonly="readonly" type="number"/></div></td>
                    <td> </td>
                </tr>
                <tr>
<td colspan='4' class='white'></td>
<td class='cyan white-text'>Grand Total</td>
<td class='cyan strong white-text'><div class="input-field col s8 "> <input type="number" readonly class="textbox" id="subTotal" name="subTotal" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placholder="Total"></div></td>
</tr>
           </tbody>
...
<div class="row"><div class="col s2">Tin No </div> <div class="input-field col s2 left"><input type="text" name='tinno' id="tinno"  class="" style="width:auto" placeholder="Tin No"/> </div></div>	
<div class="row"><div class="col s2">CST No </div><div class="input-field col s2 left"><input type="text" name='cstno' id="cstno"  class="" style="width:auto" placeholder="CST No"/> </div></div>
<div class="row"><div class="col s2">Payment </div> <div class="input-field col s2 left"><input type="text" name='payment' id="payment"  class="" placeholder="Payment"/> </div> </div>
<div class="row"><div class="col s2">Delivery</div><div class="input-field col s2 left"><input type="text" name='place' id="place"   style="width:auto"/></div></div>
...
<div class="input-field col s2 left"><b><input type="text" name='projectname' id="projectname"  class="" style="width:auto; font-weight:bold"/></b></div></div>
<div class="row"><div class="input-field col s4 left"><textarea name="address" id="address" value="" class="" ></textarea><br />
