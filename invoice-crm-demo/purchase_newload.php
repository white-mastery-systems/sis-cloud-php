...
echo "<div class='col s12 m6 l6 right rightspace' id='ven-txt'><div class='input-field col s4 left leftspace'>&nbsp;</div></div>
</div>
</div>";
echo "<div class='row'>";
echo "<div class='col12 s12 m6 l3 cyan'>";
...
echo "<input type='hidden' name='ven_id' id='ven_id' placeholder='vendor-id' class='resetThis' required='required'  /></div></div>
<div class='col s12 m6 l6 right rightspace' id='ven-txt'><div class='input-field col s8 left leftspace'>&nbsp;</div></div>
</div>
</div>";
echo "<div class='row'>
<div class='col s12'>
...
echo "<div class='col s12 m6 l6 right rightspace' id='ven-txt'><div class='input-field col s8 left leftspace'>&nbsp;</div></div>
</div>
</div>";
echo "<div  id='sub-s3' class='row  leftspace'><div class='col s2'  style='width:auto; margin:0 8px 0 0px'> Sub : PO for </div><div class='input-field col s3 left'> <input type='text' name='subject' id='subject' class='validate resetThis' placeholder='Subject' required='required' ></div> <div class='col s2'  style='width:auto; margin:0 8px 0 0px'>.</div> </div>";

echo "<div class='row  leftspace' id='pur-new'>
...
echo "<td><div class='input-field col s8'><input type='text' name='itemtotalamount[]' id='itemtotalamount_1' class='changesNo1 resetThis' readonly autocomplete='off' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required placeholder='Amount'/></div></td>";
echo "<td><div class='input-field col s8'><input type='text' name='itemVat[]' id='itemVat_1' class='resetThis changesNo1' autocomplete='off' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required placeholder='GST'/></div></td>";
echo "<td><div class='input-field col s8'><input type='text' name='itemVatamount[]' id='itemVatamount_1' class='resetThis changesNo1' autocomplete='off' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required placeholder='GST Amount' readonly /></div></td>";
...
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='subTotal1' name='subTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Sub Total' required style='border-bottom:1px solid #fff; color:#fff; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'></td>";
echo "<td  class='white'> </td>";
...
echo "<td class=''><div class='input-field col s8'><input type='text' class='resetThis' id='tptax2' name='tptax' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Transport TAX' style='border-bottom:1px solid #ccc; color:#000; text-transform:uppercase; margin: 0 0 5px 0;' />   <input type='hidden' class='resetThis' id='transporttaxAmount_s' name='transporttaxAmount_s' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Transporttax Amount' required style='border-bottom:1px solid #ccc; color:#000; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
echo "<tr>";
...
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='grandTotals' name='grandTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Grand Total' required style='border-bottom:1px solid #fff; color:#fff; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
echo "</table></div>";
echo "</div>";
echo "<div class='invoice-footer'>";
echo "<div class='row'>";
echo "<div class='col12 s12 m12 l6 leftspace lineheight' id='terms'>";
echo "<div class='row'><b>Term and Condition:</b><span class='input-field col s9'>";
echo "</span></div>";
echo "<div class='row'><div class='col s2'>Our GSTIN </div> <div class='input-field col s2 left'><input type='text' name='ogstin' id='ogstin'  class='resetThis' style='width:100%' placeholder='Our GSTIN' readonly required/> </div></div>";	
echo "<div class='row'><div class='col s2'>Party GSTIN</div><div class='input-field col s2 left'><input type='text' name='pgstin' id='pgstin'  class='resetThis' style='width:100%' placeholder='Party GSTIN' required/> </div></div>";
...
echo "<div class='row'><div class='col s2'>Loading & Transport</div><div class='resetThis input-field col s2 left'><input type='text' name='vat_o' id='vat_o'   style='width:100%'  placeholder='VAT'  class='resetThis' /></div></div>";
echo "<div class='row'><b><div class='col s2'>Please Supply by</div>   <div class='input-field col s2  date form_date'> <input size='16' type='text' value='' id='ddate' name='ddate' placeholder='Delivery Date'><span class='add-on'><i class='icon-remove'></i></span><span class='add-on'><i class='icon-th'></i></span>
</div><div class='col s1  textaligncenter'>at our</div><div class='col s2'><input type='text' name='place1' id='place1'  class='resetThis' style='width:100%' required placeholder='Place'/> </div> <div class='col s1 textaligncenter'>Site</div></b></div>";
...
echo "<td class='white'></td>";
echo "<td class='white'></td>";
echo "<td class=''>GST</td>";
echo "<td class='strong'><div class='input-field col s8 '><input type='text' class='resetThis' id='vatdr' name='vat' placeholder='VAT' onkeypress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required='required'> </div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'></td>";
echo "<td  class='white'></td>";
...
echo "<td class='strong'><div class='input-field col s8 '><input type='text' class='resetThis' id='taxAmountdr' name='taxAmountdr' placeholder='GST Amount' onkeypress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required='required'></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'></td>";
echo "<td  class='white'></td>";
