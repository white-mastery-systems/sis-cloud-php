...
<tr class="item-row"><td>.$n.</td>
<td><div class="input-field col s8 "> <input  data-type="itemCode" name="itemCode[]" class="autocomplete_txt itemDesc resetThis"  id="itemCode"  type="text"  required /></div></td>
...
<td><div class="input-field col s8 "><input name="itemQty[]"  class="itemQty resetThis" id="itemQty" type="number" pattern="[0-9]*" required /></div></td>
<td><div class="input-field col s8 "><input name="itemDesc[]" class="itemDesc resetThis" id="itemDesc" type="text"   required  ></div></td>
<td><div class="input-field col s8 "><input name="itemBasic_m[]" class="rateb resetThis" id="itemBasic_m" type="number"/></div></td>
<td><div class="input-field col s8 "><input name="itemTotal_m[]" class="itemTotal_m resetThis" id="itemTotal_m" readonly="readonly" type="number"/></div></td>
<td><div class="input-field col s8 "><input name="itemBasic_i[]" class="ratei resetThis" id="itemBasic_i" type="number"/></div></td>
<td><div class="input-field col s8 "><input name="itemTotal_i[]" class="itemTotal_i resetThis" id="itemTotal_i" readonly="readonly" type="number"/></div></td>
...
<td></td>
<td>ED</td>
<td><div class="input-field col s8 "><input name="ed"  class="ed" id="ed" type="number" pattern="[0-9]*" required /></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Vat</td>
<td><div class="input-field col s8 "><input name="vat"  class="vat" id="vat" type="number" pattern="[0-9]*" required /></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Grand Total</td>
<td><div class="input-field col s8 "><input name="gt"  class="gt" id="gt" type="number" pattern="[0-9]*" required /></div></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td class='cyan white-text'>Grand Total</td>
<td class='cyan strong white-text'><div class="input-field col s8 "><input type="number" readonly class="" id="subTotal" name="subTotal" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placholder="Total"></div></td>
</tr>
</tbody>
</table>
</div>
...
<div class="row"><div class="col s2 right">  <button type="submit" class="btn-floating btn-large waves-effect waves-light cyan" title="submit"><i class="material-icons medium">done</i>></button> <a class="btn-floating btn-large waves-effect waves-light" title="Cancel"><i class="material-icons medium">clear</i></a></div></div>
 ...
 <!-- //////////////////////////////////////////////////////////////////////////// -->
  ...
  <script type="text/javascript">      var j = jQuery.noConflict();</script>
    ...
    <script  type="text/javascript" src="js/jq-ac-script_w.js"></script>
