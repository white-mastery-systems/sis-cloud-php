...
<script type="text/javascript" src="js/jquery-1.11.2.min.js">
     ...
     <script type="text/javascript">
         var j = $.noConflict();</script>
     
        <script>
            // Perfect Scrollbar

            $j('select').not('.disabled').material_select();
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation ps-container ps-active-y" style="width: 240px;">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold active"><a  href="#Clientrequirement" class="collapsible-header  waves-effect waves-cyan active" rel="ajax"><i class="mdi-social-pages"></i> Client Requirement</a></li>
                    ...
                    <li class="bold"><a href="#inventoryuse" class="collapsible-header  waves-effect waves-cyan" rel="ajax"><i class="mdi-image-image" rel="ajax"></i> Inventoryuse</a></li>
                   <li class="bold"><a href="#status" class="collapsible-header waves-effect waves-cyan" rel="ajax"><i class="mdi-editor-insert-chart" rel="ajax"></i>Status</a></li>
