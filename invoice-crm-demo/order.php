...
<?php if( $_SESSION['place'] == 'All' )	{?>	
<span id="ord-head" class="right rightspace navigationsbuttons"><a href="vendor.php" class="btn btn-success cyan" type="button">Vendors</a> <a href="products.php" class="btn btn-success cyan" type="button">Products</a></span>
<h5 id="ord-head" class="breadcrumbs-title">Purchase Order</h5>
<span id="ord-headright" class="right rightspace navigations">  
      ...
      <li class="mfb-component__wrap">
          ...
          <li>
            <a href="#" data-mfb-label="Add Products" class="mfb-component__button--child" onClick="fun_add()">
              <i class="mfb-component__child-icon ion-social-twitter"><img src="images/products_addmall.png" /></i>
									...
									<span class="right navigations1"><a class="mfb-component__button--main" title="Delete" id="del_all" style="display:none"> <i class=" mfb-component__main-icon--resting material-icons" title="Cancel">delete</i></a></span> <?php } else{
                                    ?>
					...
					<div class="row white">
						...
						<div class="section topspace">
							...
							<input type="hidden" name="place" id="place" value="<?php echo $_SESSION['place']?>">
						...
						<table id="itemsTable" cellpadding="0" cellspacing="0" width="100%" border="0" class="table avail-div m-b-60 hidedata">
										<thead>
											<tr class="title">
												<th class="font12 datatable-nosort">
		...
		<div class="modal fade" id="overlay" style="">
			<div class="modal-dialog col s12 m12 l12">
				<div class="modal-content">
					...
					<div class="modal-body  page-wrapper scrollbar-macosx" id="modalbody" >
						...
						<div style="width:300px;" id="add-content">
							...
							<form id="fm" method="get" novalidate="novalidate" class="fm-delete">
								<div class="fitem">
									...
									<input name="po_year" id="po_year" value="" style="border:none" type="hidden">
						...
						<div style="width:350px;" id="add-content">
							...
							<form id="fm" method="get" novalidate="novalidate" class="fm-delete1">
								<div class="fitem">
									...
									<input name="po_year" id="po_year2" value="" style="border:none" type="hidden">
		...
		<!-- Reopen -->
    <div class="modal fade" id="overlayreopen" style="">
			<div class="modal-dialog" style="width:300px;">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
					...
					<div class="modal-body">
						...
						<div style="width:300px;" id="add-content">
							...
							<form id="fm" method="get" novalidate="novalidate" class="fm-reopen">
								<div class="fitem">
									Are you sure want to <b>REOPEN</b> this
									<input name="po_no" id="po_no3" value="" style="border:none" type="hidden">
									<input name="po_year" id="po_year3" value="" style="border:none" type="hidden">
									<input name="status" id="status3" value="" style="border:none" type="hidden">
									<input name="action" id="action3" value="reopen" style="border:none" type="hidden">
								</div>
								<div align="right" style="padding-top:15px; padding-right:40px">
    ...
    var res = str.split("+");
						//alert(res[0]);
						document.getElementById("po_year").value = res[0];
    ...
    var res = str.split("+");
						//alert(res[0]);
						document.getElementById("po_year2").value = res[0];
...
var dataTable = $('#itemsTable').DataTable({
					...
					, "serverSide": true
					, 'ajax': {
						url: "order_load.php?action="+typeval+"&place="+place, // json datasource	
...
$(document).on('submit', '.fm-delete', function () {
				...
				return false;
                  ...
                  $(document).on('submit', '.fm-reopen', function () {
                    
				$('#logerror').html('<img src="ajax.gif" align="absmiddle"> Please wait...');
                    var data = $(".fm-reopen").serialize();
                    alert(data);
				$.ajax({
					type: "POST"
					, url: "order_loadaction.php",
                    data: $(".fm-reopen input").filter(function () {
						return !!this.value;
					}).serialize(), // serializes the form's elements.
					success: function (data) {
                        alert(data);
			...
			function fun_edit(str,str1) {
				...
				window.location =  "purchase_edit.php?po_no=" + str+"&po_year="+str1;
			}

			function fun_pdf(str,str1) {
				location.href = "purchase_pdf1.php?po_no=" + str+"&po_year="+str1;
			...
			**/
			...
			function fun_email(str,str1) {
				...
				xmlhttp.open("GET", "purchaseemail_popup.php?po_no=" + str+"&po_year="+str1, true);
				xmlhttp.send();
			...
			function viewpo(str,str1) {
				...
				xmlhttp.open("GET", "purchase-view.php?po_no=" + str+"&po_year="+str1, true);
				xmlhttp.send();
			}
		</script>
		...
		<script type="text/javascript">
			function sendemail() {
				...
				//var email_content = $('#editor').text();
				var email_content = $('#editor').html();	
				var email_content1 = $('#editor').text();
								if (window.XMLHttpRequest) { // code for IE7+, Firefox, Chrome, Opera, Safari
					xmlhttp = new XMLHttpRequest();
				} else { // code for IE6, IE5
					xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
				...
				xmlhttp.open("GET", "purchase_email.php?po_no="+po_no+"&invoice_mail="+invoice_mail+"&email_content="+ email_content+"&emailcc="+emailcc+"&emailbcc="+emailbcc+"&po_year="+po_year+"&esub="+esub+"&email_content1="+email_content1, true);
				xmlhttp.send();
