...
We are pleased to place the Purchase order as per the details mentioned below for our Project</div> <div class="col s2 left"><select name="project_name" id="project_name" onChange="projectlist(this.value)" required="required">
<?php
require('connect.php');
...
<td><div class="input-field col s8 "> <input  data-type="product_code"  id="itemCode_1"  name="itemCode[]" class="autocomplete_txt resetThis"   type="text"  required autocomplete="off"  /></div></td>
<td><div class="input-field col s8 "> <input name="itemWidth[]" id="itemWidth_1"  type="text"  required autocomplete="off" /></div></td>
<td><div class="input-field col s8 "><input name="itemHeight[]" id="itemHeight_1" type="number" pattern="[0-9]*" required autocomplete="off" /></div></td>
<td><div class="input-field col s8 "><input name="itemQty[]"  id="itemQty_1" type="number" pattern="[0-9]*" class="changesNo" required autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" /></div></td>
...
<td></td>
<td>
      			<button class="btn btn-success addmore" type="button">+ Add More</button></td>
<td>	<button class="btn btn-danger delete" type="button">- Delete</button></td>
<td></td>
<td>BC</td>
<td><div class="input-field col s8 "><input name="basictotal"  class="basictotal" id="basictotal" type="number" pattern="[0-9]*" required /></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>ED</td>
<td><div class="input-field col s8 "><input type="number"  name="ed" id="ed" placeholder="ED" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/><input type="number"  name="edval" id="edval" placeholder="ED" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Vat</td>
<td><div class="input-field col s8 "><input type="number"  name="vat" id="vat" placeholder="VAT" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Transpotation</td>
<td><div class="input-field col s8 "><input name="tp"  class="tp" id="tp" type="number" pattern="[0-9]*" required /></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>ST</td>
<td><div class="input-field col s8 "><input name="st"  class="st" id="st" type="number" pattern="[0-9]*" required/></div></td>
<td>&nbsp;</td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Grand Total</td>
<td><div class="input-field col s8 "><input name="gt"  class="gt" id="gt" type="number" pattern="[0-9]*" required readonly /></div></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td class='cyan white-text'><div class="input-field col s8 "><input name="gt1"  class="gt1" id="gt1" type="number" pattern="[0-9]*" required  readonly /></div></td>
<td class='cyan strong white-text'><div class="input-field col s8 "><input type="number" name="subTotal" class="amountDue" id="subTotal" placeholder="Amount Due" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
</tr>
</table>
</div>
</div>
