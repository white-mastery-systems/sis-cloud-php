...
isset($_POST['vat_o']) ? $vat = $_POST['vat_o'] : $vat = "0";
...
if( $itemDesc != '')
{
$sql = "INSERT INTO purchaseorder_tbl(product_name,product_code,Po_no,product_qty,ratesperproduct,Amount,vat,po_date,cat_name,sub_catname,units,status,stock_received) VALUES ('$itemDesc','$product_code',$po_no,$itemQty,$itemPrice,'$itemLineTotal','$itemVat','$po_date','$cat_name','$sub_catname','$units','open','0')";
echo $sql;
...
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,status,po_no,stock,stock_balance,stk_received) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','invoiceraised',$po_no,$itemQty,$itemQty,'0')";
...
if( $itemDesc != '')
{
			...
			$sql = "update purchaseorder_tbl set product_name='$itemDesc',Po_no='$po_no',product_code='$product_code',product_qty='$itemQty',ratesperproduct='$itemPrice',Amount='$itemLineTotal',vat='$itemVat',po_date='$po_date',cat_name='$cat_name',sub_catname='$sub_catname',units='$units',status='open' where po_id=$po_id and Po_no=$po_no";
			echo $sql."Updated";
$result = mysql_query($sql,$conn);

$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
$result3 = mysql_query($sql3,$conn);	
$sql4 = "update  stocklist set pro_name='$itemDesc',product_code='$product_code',cat_name='$cat_name',sub_catname='$sub_catname',price='$itemPrice',brand='$brand',project_name='$project_name',status='invoiceraised',po_no='$po_no',stock='$itemQty',stock_balance='$itemQty' where WHERE po_no=$po_no and pro_name='$itemDesc' ";
$result4 = mysql_query($sql4,$conn);
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
$query_run = mysql_query($query,$conn); 	
while ($req_row = mysql_fetch_array($query_run)) 
...
if( $itemCode != '')
{
$sql = "INSERT INTO purchaseorder_tbl(product_code,product_name,Po_no,product_qty,m_basic,m_total,i_basic,i_total,ed,vat,st,transportation,units,Amount,status,pro_height,pro_width,stock_received) VALUES ('$itemCode','$itemDesc',$po_no,$itemQty,$itemBasic_m,$itemTotal_m,$itemBasic_i,$itemTotal_i,$ed,$vat,$st,$transportation,'$itemUnit','$itemLineTotal','open','$itemHeight','$itemWidth','0')";
echo $sql;
$result = mysql_query($sql,$conn);
$sql3 = "update productlist set m_basic ='$itemBasic_i',i_basic='$itemTotal_i' where product_code='$itemCode'";
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,itemHeight,itemWidth,itemBasic_m,item_totali,brand,project_name,status,po_no,stock,stock_balance,stk_received) VALUES('$itemDesc','$itemCode','$itemHeight','$itemWidth','$itemBasic_m','$itemBasic_i','$itemBrand','$project_name','invoiceraised',$po_no,$itemQty,$itemQty,'0')";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
...
$sql1 = "UPDATE purchase_master SET po_date='$po_date',project_id='$project_id',ven_id='$ven_compname',subtotal='$totalAfter',ddate='$ddate',ed='$ed',vat='$vat',st='$st',transportation='$transportation',status='open',project_name='$project_name',Block='$blockname',description='$desc',gt='$gt',gt1='$gt1',type='$type',refno='$refno',refdate='$refdate',stotal='$subTotal',basictotal='$basictotal',itotal='$itotal',folder='$folder',payment='$payment',subject='$subject',contactname='$contactname',mobileno='$mobileno' WHERE po_no='$po_no' ";
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
}
...
if( $itemDesc != '')
{
$sql = "INSERT INTO purchaseorder_tbl(product_name,Po_no,product_qty,ratesperproduct,Amount,product_code,po_date,cat_name,sub_catname,units,status,product_cft,size,brand,stock_received) VALUES ('$itemDesc','$po_no','$itemQtyd','$itemPrice','$itemLineTotal','$product_code','$po_date','$cat_name','$sub_catname','CFT','open','$itemQty','$size','$brand','0')";
echo $sql;
$result = mysql_query($sql,$conn);
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,size,brand,project_name,status,po_no,stock,stock_balance,stk_received) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$size','$brand','$project_name','invoiceraised',$po_no,$itemQtyd,$itemQtyd,'0')";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
echo $query;
...
if( $itemDesc != '')
{
$sql = "UPDATE purchaseorder_tbl SET product_name='$itemDesc',product_qty='$itemQtyd',ratesperproduct='$itemPrice',Amount='$itemLineTotal',product_code='$product_code',po_date='$po_date',cat_name='$cat_name',sub_catname='$sub_catname',units='CFT',status='open',product_cft='$itemQty',size='$size',brand='$brand' WHERE Po_no =$po_no and po_id=$po_id";
echo $sql;
$result = mysql_query($sql,$conn);
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "UPDATE  stocklist SET pro_name='$itemDesc',product_code='$product_code',cat_name='$cat_name',sub_catname='$sub_catname',price='$itemPrice',size='$size',brand='$brand',project_name='$project_name',status='invoiceraised',stock='$itemQtyd',stock_balance='$itemQtyd',stk_received='0' WHERE po_no=$po_no and product_code='$product_code'";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
echo $query;
...
echo mysql_real_escape_string($desc);
$sql1 = "UPDATE purchase_master SET po_date='$po_date',project_id='$project_id',ven_id='$ven_compname',subtotal='$totalAfter',ddate='$ddate',vat='$vat',status='open',project_name='$project_name',Block='$blockname',description='$desc',type='$type',refno='$refno',refdate='$refdate',folder='$folder',tax='$vat',stotal='$subTotal',payment='$payment',subject='$subject',contactname='$contactname',mobileno='$mobileno' WHERE po_no='$po_no'";
echo $sql1;
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
...
if( $itemDesc != '')
{
$sql = "INSERT INTO purchaseorder_tbl(product_name,Po_no,product_qty,ratesperproduct,Amount,vat,po_date,cat_name,sub_catname,units,status,details,brand,stock_received) VALUES ('$itemDesc',$po_no,$itemQty,$itemPrice,'$itemLineTotal','$itemVat','$po_date','$cat_name','$sub_catname','$units','open','$details','$brand','0')";
echo $sql;
$result = mysql_query($sql,$conn);
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,status,po_no,stock,stock_balance,details,stk_received) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','invoiceraised',$po_no,$itemQty,$itemQty,'$details','0')";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
echo $query;
...
$sql = "UPDATE purchaseorder_tbl SET product_name='$itemDesc',product_qty='$itemQty',ratesperproduct='$itemPrice',Amount='$itemLineTotal',vat='$itemVat',po_date='$po_date',cat_name='$cat_name',sub_catname='$sub_catname',units='$units',status='open',details='$details',brand ='$brand' WHERE Po_no=$po_no AND po_id = $po_id";
echo $sql;
$result = mysql_query($sql,$conn);

$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
$result3 = mysql_query($sql3,$conn);
$sql4 = "UPDATE stocklist SET pro_name='$itemDesc',product_code='$product_code',cat_name='$cat_name',sub_catname='$sub_catname',price='$itemPrice',brand='$brand',project_name='$project_name',status='invoiceraised',stock='$itemQty',stock_balance='$itemQty',details='$details',stk_received='0' WHERE po_no=$po_no and pro_name='$itemDesc'";
$result4 = mysql_query($sql4,$conn);
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
$query_run = mysql_query($query,$conn); 	
while ($req_row = mysql_fetch_array($query_run)) 
