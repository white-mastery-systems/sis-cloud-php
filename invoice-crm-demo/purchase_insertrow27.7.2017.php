...
$sql1 = "INSERT INTO purchase_master(po_no,po_date,project_id,ven_id,subtotal,ddate,vat,status,project_name,Block,description,type,refno,refdate,folder,payment,subject,contactname,mobileno,tpwords,po_year,place,ogstin,pgstin,tp,tpamount,tstatus,gst_status) VALUES ('$po_no','$po_date','$project_id','$ven_compname','$subTotal','$ddate','$tax','open','$project_name','$blockname','$desc','$type','$refno','$refdate','$folder','$payment','$subject','$contactname','$mobileno','$tpwords','$po_year','$city','$ogstin','$pgstin','$transportation','$tpamount','$tstatus','included')";
