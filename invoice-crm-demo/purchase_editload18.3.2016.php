...
echo "<td><div class='input-field col s8'><input type='text' data-type='pro_name' name='itemDesc[]' id='itemDesc_".$n."' class='resetThis autocomplete_txt1' autocomplete='off'  value='".$productname."' placeholder='DESC' required='required' /> </div></td>";
...
echo "<div class='row'><div class='col s2 right'>  <button type='submit' class='btn-floating btn-large waves-effect waves-light cyan' title='submit'><i class='material-icons medium'>done</i>></button> <a class='btn-floating btn-large waves-effect waves-light' title='Cancel' id='clear' style='background-color:#e91e63;'><i class='material-icons medium'>clear</i></a></div></div>";
}
else if($type == "upvc")
{
echo "<div class='row topspacelarge' align='center'>";
...
echo "<td><div class='input-field col s8 '><input data-type='pro_name' name='itemDesc[]'  id='itemDesc_".$n."'  type='text' class='autocomplete_txt'  required tocomplete='off' placeholder='Type'  value='".$productname."' class='resetThis' required='required' /></div></td>";
...
echo "<td><input type='checkbox' id='selecttd1".$n."'  class='case' value='".$po_id."' /><label for='selecttd1".$n."'></label></td>";
echo "<td><div class='input-field col s8'><input type='text' data-type='pro_name' name='itemDesc[]' id='itemDesc_".$n."'  class='resetThis autocomplete_txtsteel' autocomplete='off'  value='".$productname."' placeholder='DESC' required='required' /></div></td>";
...
echo "<td><div class='input-field col s8'><input type='text' data-type='pro_name' name='itemDesc[]' id='itemDesc_".$n."'  class='resetThis autocomplete_txtdoor' autocomplete='off'  value='".$productname."' placeholder='DESC' required='required'></div></td>";
