	 ...
	 foreach($dbper as $val)
		{
			...
			while($row = mysql_fetch_array($result))
			{
				...
				$sql_submenu = "select * from  menu where mainmenu ='".$val."'";
				
				$result1= mysql_query($sql_submenu,$conn);
			...
			echo '<li class="bold '.$classname.'"><a href="'.$link.'" class="waves-effect waves-cyan"><i class="material-icons">'.$iconsname.'</i>'.$dispname.'</a>
				...
				else
				{
					...
					echo '<li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-social-pages"></i> Pages</a>
                                <div class="collapsible-body" style="">
                                  <ul>                                        
                                        <li><a href="http://demo.geekslabs.com/materialize/v2.2/layout01/page-contact.html">Contact Page</a>
                                        </li>
