...
<style type="text/css">
   <!--
   @page { size:8.5in 11in; margin: 1.8in 0.2in 1in 0.2in; 
     ...
     <div class="fitem" style="padding-bottom:10px;">
      ...
      <option value="standard">standard</option>
        ...
        <div class="fitem subcat">
           ...
           <div align="right" >           
<button type='submit' class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" title='submit'><i class='material-icons small'>done</i></button>  <button type='button' id="clear" style="background-color:#ff4081" class='btn-floating btn-medium waves-effect waves-light' onClick="popupclose()"><i class='material-icons small'>clear</i></button></div>
			   </form>
...
<!-- Print -->
 ...
 <div class="modal fade" id="overlayadd_vendor" style="">
  ...
  <form id="fm" method="get" novalidate="novalidate" class="fm-addvendor">
        ...
        <div align="right" >           
<button type='submit' class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" title='submit'><i class='material-icons small'>done</i></button>  <button type='button' id="clear" class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" onClick="popupclose()"><i class='material-icons small'>clear</i></button></div>
			   </form>
...
<!--   Delete temp -->
 ...
 <button type='submit' class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" title='submit'><i class='material-icons small'>done</i></button>  <button type='button' id="clear" style="background-color:#ff4081" class='btn-floating btn-medium waves-effect waves-light' onClick="popupclose()"><i class='material-icons small'>clear</i></button>
</div>
</form> 
</div>
</div>
