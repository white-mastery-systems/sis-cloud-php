...
<div class='col s12 m6 l6'><div class="input-field col s5 left leftspace"><input type="text" id="vendor_name" name="vendor_name" placeholder="Vendor Name"  required /> </div></div>
...
<div class='col s12 m6 l6'><div class="input-field col s5 left leftspace"><textarea name="ven_add" id="ven_add" value="" readonly></textarea>
...
<div class="input-field col s2"> 
  <input type="text" name="ven_contactperson" id="ven_contactperson" placeholder="Contact Person" readonly/></div>
  </center>
  </div>
</div>
<div class="row leftspace">
<div class='col12 s12 m6 l3 cyan'>
 <div class="col s12">Ref: Ch-77112-Amended Qty Without Glass Dated 28.08.2015</div>
...
<div class="col s1 left" style="width:auto; margin:0 10px 0 10px"> @ </div>
<div class="col s2 left">
<input type="text" name='place' id="place"   style="width:auto" placeholder="Place" readonly/> </div>
<div class="col s2 left">
...
<td><div class="input-field col s8 "> <input  data-type="product_code"  id="itemCode_1"  name="itemCode[]" class="autocomplete_txt resetThis"   type="text"  required autocomplete="off"  /><input  id="itemBrand_'+i+'"  name="itemBrand[]" class="resetThis" type="hidden"  required autocomplete="off"  /></div></td>
<td><div class="input-field col s8 "> <input name="itemWidth[]" id="itemWidth_1"  type="text"  required autocomplete="off" /></div></td>
<td><div class="input-field col s8 "><input name="itemHeight[]" id="itemHeight_1" type="number" required autocomplete="off" /></div></td>
<td><div class="input-field col s8 "><input name="itemQty[]"  id="itemQty_1" type="number" class="changesNo" required autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" /> <input name="itemUnit[]"  id="itemUnit_1" type="hidden" required autocomplete="off" /></div></td>
<td><div class="input-field col s8 "><input data-type="pro_name" name="itemDesc[]"  id="itemDesc_1" type="text" class="autocomplete_txt"  required tocomplete="off" ></div></td>
<td><div class="input-field col s8 "><input name="itemBasic_m[]"  id="itemBasicm_1" type="number" autocomplete="off" class="changesNo" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></div></td>
<td><div class="input-field col s8 "><input name="itemTotal_m[]" id="itemTotalm_1" readonly="readonly" type="number" autocomplete="off" class="totalLinePrice1"/></div></td>
<td><div class="input-field col s8 "><input name="itemBasic_i[]"  id="itemBasici_1" type="number" autocomplete="off" class="changesNo" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></div></td>
<td><div class="input-field col s8 "><input name="itemTotal_i[]" id="itemTotali_1" readonly="readonly" type="number" autocomplete="off" class="totalLinePrice2"/></div></td>
...
<td></td>
<td>BC</td>
<td><div class="input-field col s8 "><input name="basictotal"  class="basictotal" id="basictotal" type="number" required /></div>	<input type="hidden"  class="itotal" id="itotal" name='itotal' required /><input type="hidden" class="form-control" id="subTotal" placeholder="Subtotal" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>ED</td>
<td><div class="input-field col s8 "><input type="number"  name="ed" id="ed" placeholder="ED" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Vat</td>
<td><div class="input-field col s8 "><input type="number" class="form-control" id="vat" name="vat" placeholder="vat" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"><input type="hidden" class="form-control" id="taxAmount1" placeholder="Tax" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"><input type="hidden" class="form-control" id="taxAmount" placeholder="Tax" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Transpotation</td>
<td><div class="input-field col s8 "><input type="number" class="form-control" id="tp" name="tp" placeholder="Amount Paid" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"><input type="hidden" class="form-control" id="tp1" name="tp1" placeholder="Amount Paid" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
<td></td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td></td>
<td><input type="hidden" class="form-control amountDue" id="amountDue" placeholder="Amount Due" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
<td>ST</td>
<td><div class="input-field col s8 "><input type="number" class="form-control" name="st" id="st" placeholder="st" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/> <input type="hidden" class="form-control" id="taxAmount2" placeholder="Tax2" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
<td>&nbsp;</td>
<td></td>
<th></td>
<td></td>
...
<td></td>
<td>Grand Total</td>
<td><div class="input-field col s8 "><input name="gt"  class="amountDue1 gt" id="gt" type="number" required readonly /></div></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td class='cyan white-text'><div class="input-field col s8 "><input name="gt1"  class="gt1" id="gt1" type="number" required  readonly /></div></td>
<td class='cyan strong white-text'><div class="input-field col s8 "><input type="number" class="form-control" id="totalAftertax" name="totalAftertax" placeholder="Total" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly></div></td>
</tr>
</table>
</div>
</div>
...
<div class="row"><b>Term and Condition:</b><span class="input-field col s8 ">
</span></div>
...
<div class="row"><b> <div class="col s2">Site contact Person </div><div class="input-field col s2 left"><input type="text" name='contactname' id="contactname"  class="" style="width:auto"/></div><div class="col s2 textaligncenter">Mobile :</div>     <div class="input-field col s2 left"><input type="text" name='mobilno' id="mobilno"  class=""/></div> </b></div>
...
<div class="row"><div class="input-field col s4 left"><textarea name="address" id="address" value="" class="" readonly placeholder="address"></textarea><br />
<input type="text" name='project_id' id="project_id"  class="" style="width:auto"/></div></div>
</p>
</div>
...
<div class="row"><div class="col s2 right">  <button type="submit" class="btn-floating btn-large waves-effect waves-light cyan" title="submit"><i class="material-icons medium">done</i>></button> <a class="btn-floating btn-large waves-effect waves-light" title="Cancel"><i class="material-icons medium">clear</i></a></div></div>
 ...
 <!-- //////////////////////////////////////////////////////////////////////////// -->
  ...
  <script type="text/javascript">      var j = jQuery.noConflict();</script>
    ...
    <script  type="text/javascript" src="js/jquery-ui-1.8.14.custom.min.js"></script><br>
