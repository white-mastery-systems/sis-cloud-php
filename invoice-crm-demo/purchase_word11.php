...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:295px; font-siz:13px; font-family:cambria' align='center'><b>Description</b></th>";
...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:270px; font-siz:13px; font-family:cambria' align='right' ><b>Total  in <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "</tr>";
$html.= "</thead>";
$html.= "<tbody>";
...
Thanking you, <br />
Yours Sincerely<br />
<img src='images/anisa_digi.jpg' width='60' height='50' /><br>
Anisa Fathima.H<br/>Purchase Manager
...
$mpdf->Output("purchaseorder/PO-".$po_no. ".docx");
...
$html.= "<thstyle='border-collapse: collapse; border:solid 1px #000; padding-right:10px' align='right'><b></b></th>";
$html.= " </tr>";
$result_r = mysql_query("SELECT * FROM  purchaseorder_tbl where Po_no=" .$po_no,$conn);
...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000; ' align='center'><b>Price in <span><img src='images/rupee.jpg' /> </span> </b> </th>";
$html.= "<th style='border-collapse: collapse; border:solid 1px #000; padding-right:10px' align='right'><b>Total in <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "</tr>";$html.= "</thead>";
$html.= "<tbody>";
$result_r = mysql_query("SELECT * FROM  purchaseorder_tbl where Po_no=" .$po_no,$conn);
while($row = mysql_fetch_array($result_r))
...
$html.= "<tr>";                
$html.= "<tr><td style='border-collapse: collapse; border:solid 1px #000; ' align='center'>".$n."</td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center'>" .$product_code. "</td>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center'>" .number_format($Amount, 2, '.', ''). "</td>";
$html.= "</tr>";
 }
$html.= "<tr>";
$html.= "<td colspan='6' class='white'style='border-collapse: collapse; border:solid 1px #000; ' align='center'></td>";
$html.= "<td class='cyan white-text'>SubTotal</td>";
$html.= "<td class='cyan strong white-text' style='width:auto'>".number_format($stotal, 2, '.', '')."</td>";
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td colspan='6' class='white'></td>";
$html.= "<td class=''>vat</td>";
$html.= "<td class=''>".$tax."%</td>";
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td colspan='6' class='white'></td>";
$html.= "<td class='cyan white-text'>Grand Total</td>";
$html.= "<td class='cyan strong white-text'>  <span><img src='images/rupee.jpg' /> </span>  ".number_format($subtotal, 2, '.', '')."</td>";
$html.= "</tr>";
$html.= "</tbody>";
$html.=  "</table>";
