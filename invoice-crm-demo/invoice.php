...
$num_rows = mysqli_num_rows($result_bal);
?>
...
<?php while($row_bal = mysqli_fetch_array($result_bal))
{
...
<br>&nbsp;
    ...
    <select id="projectname" name="projectname" ><option value="S.I.S Queenstown">S.I.S Queenstown</option><option value="S.I.S Marakesh">S.I.S Marakesh</option><option value="S.I.S Acropole">S.I.S Acropole</option><option value="S.I.S Luxor">S.I.S Luxor</option><option value="S.I.S Capetown">S.I.S Capetown</option><option value="S.I.S Sintra">S.I.S Sintra</option></select>
    <?php
}
?>
<br>&nbsp;
						...
						<div style="width:300px;" id="add-content">
							...
							<form id="fm" method="get" novalidate="novalidate" class="fm-delete">
								<div class="fitem">
									...
									<input name="po_no" id="po_no" value="" style="border:none" type="text">
								    <input name="action" id="action" value="delete" style="border:none" type="text">
								</div>
...
var dataTable = $('#itemsTable').DataTable({
	...
	if (projectname == 'S.I.S Marakesh') {
		  ...
		  $('#itemsTable').dataTable().fnDestroy();
           ...
           else if (projectname == 'S.I.S Sintra') {
		  $('#itemsTable').dataTable().fnDestroy();
			}      
...
function fun_view(str,str1) 
		...
		<script type="text/javascript">
			function richeditor()
			{
			$.getScript('https://mindmup.github.io/bootstrap-wysiwyg/external/jquery.hotkeys.js',function(){
$.getScript('https://mindmup.github.io/bootstrap-wysiwyg/bootstrap-wysiwyg.js',function(){
