...
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='subTotal' name='subTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Sub Total' required style='border-bottom:1px solid #fff; color:#fff; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
...
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='grandTotal' name='grandTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Grand Total' required style='border-bottom:1px solid #fff; color:#fff; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
echo "</table></div>";
echo "</div>";
...
echo "<div class='row'><b><div class='col s2'>Please Supply by</div>   <div class='input-field col s2  date form_date'> <input size='16' type='text' value='' id='ddate' name='ddate' placeholder='Delivery Date'>
