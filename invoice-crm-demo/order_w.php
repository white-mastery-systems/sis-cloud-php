...
<body class="loaded">
          ...
          <div class="container-title">
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <span  style="position:relative; top:45px;width:auto" class="right rightspace">  
  ...
  <span style="position:relative; top:45px; width:auto; right:100px" class="right"><a class="btn-floating btn-large waves-effect waves-light" title="Delete" id="del_all" style="display:none"> <i class="material-icons" title="Cancel">delete</i></a></span> 
              </div>
            </div>
