...
if($row1['folder'] == 'Switches' or $row1['folder'] == 'Swimming Pool')
{
...
$html.= "<td colspan='1' class='white'></td>";
 ...
 if($folder == 'Switches' or $folder == 'Swimming Pool')
{
...
$html.= "<tr><td colspan='3'>Please start the work by " .$ddate. " at our ".$place;
