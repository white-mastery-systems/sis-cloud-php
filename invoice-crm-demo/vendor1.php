    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation ps-container ps-active-y" style="width: 240px;">
            ...
            <li class="bold"><a href="#" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> User</a>
            </li>
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i> Workassign</a></li>
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-image-palette"></i>Timescale</a></li>
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-border-all"></i>Order</a></li>
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-comment"></i> Forms</a></li>
                    <li class="bold active"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-social-pages"></i> Client Requirement</a></li>
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-shopping-cart"></i>Inventory</a></li>
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-image-image"></i> Inventoryuse</a></li>
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-account-circle"></i>Sales</a></li>
                    
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-chart"></i>Status</a></li>
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-chart"></i>Quality</a></li>
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-chart"></i>Delay</a></li>
                </ul>
            </li>
      ...
      <section id="content">
          ...
          <div class="container-title">
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <div  style="position:relative; top:45px; margin-left:10px; width:auto" class="right rightspace"><a class="btn-floating btn-large waves-effect waves-light" title="Purchase New"><img src="images/cart-plus.png" /></a> <a class="btn-floating btn-large waves-effect waves-light" title="Add Vendor"><img src="images/addvendor_small.png" /></a> <a class="btn-floating btn-large waves-effect waves-light" title"Add Products"><img src="images/products_addmall.png" /></a></div>
              </div>
            </div>
          </div>
        </div>
       ...
       <table class="table table-full m-b-60" border="0" width="100%">
      <thead>
        <tr>
          <th align="center">  <input type="checkbox" id="check1" />
    <label for="check1"></label></th>
<th><b>Icon</b></th>
          <th class="style1"><b>Invoice No  </b> <i class="material-icons tiny1">sort</i></th>
          <th><b>Date </b> <i class="material-icons tiny1">sort</i></th>
           <th class="style2"><b>Summary</b></th>
           <th class="style3"><b>Invoice Total Rs</b></th>
            <th><b>Action</b></th>
        </tr>
      </thead>
      <tbody>
...
$result = mysql_query("SELECT * FROM  purchase_master where status='open' ORDER BY po_no DESC",$conn);
  ...
  ?>
        <tr>
          <td align="center"><input type="checkbox" id="<?php echo $row['p_id']; ?>" />
    <label for="<?php echo $row['p_id']; ?>"></label></td>
          <td></td>
          <td class="style1"><?php echo $row['po_no'];?></td>
          <td><?php echo $row['po_date']; ?> </td>
          <td class="style2"><a href="#" id="<?php echo $row['po_no'];?>" onclick="viewpo(<?php echo $row['po_no'];?>)">View PO</a></td>
          <td class="style3"><?php echo number_format($row['subtotal']), 2, ',', ' '); ?></td>
          <td><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><a href="#" title="Duplicate"><i class="material-icons tiny">content_copy</i></a></div>  <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="Print">print</a></i></div><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="Email">email</a></i></div><div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny" title="Cancel"><a href="#">delete</a></i></div> <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12"><i class="material-icons tiny"><a href="#" title="PDF">picture_as_pdf</a></i></div></div></td>
        </tr>
        <?php
}
?>            
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>&copy;  <a class="grey-text text-lighten-4" href="#" target="_blank">Copyright South India Shelters Pvt.Ltd. </a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">S.I.S</a></span>
        </div>
    </div>
  </footer>
  <!-- END FOOTER -->
