...
{
$html.=  " Project <b> " .$project_name."&nbsp; ".$block."</b>&nbsp; Block  ";
}
else
{
...
$html.= "<tr>";
$html.= "<td colspan='3'><b>Terms and Condition:</b> </td>";
$html.= "</tr>";
$html.= "<tr>";
...
$html.= "<tr>";
$html.= "<td  colspan='3'>
<p  align='justify' style='line-height:160%;'>
1.Provided with Garbage room of size 1.5Mtr x 2mtr. Minimum at Ground level just below the Chute duct.The garbage room will be totally non-ventilatroom. The room floor will be given a slope toward the gulley trap for the cleaning water & phenyl drain.</p>
<p  align='justify' style='line-height:160%;'>2.1.5".chr(34). " water connection from overhead water tank.</p>
<p  align='justify' style='line-height:160%'>
3.We will provide storage of chute material, electricity & water free of cost.</p>
<p  align='justify' style='line-height:160%'>
4.Wet riser along with connections up to the fire sprinklers (ready to connect the fire sprinklers.<br><br></p>
<p  align='justify' style='line-height:200%'>
The above price is net price inclusive of all Taxes and Transport Charges.<br><br></p>
<p  align='justify' style='line-height:200%'>
The Other terms and conditions remains the same as per your Quote.<br><br></p>";
$html.= "</td></tr>";
