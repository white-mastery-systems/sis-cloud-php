...
<div class='col s12 m6 l6'><div class="input-field col s5 left leftspace"><input type="text" class="resetThis" id="vendor_name" name="vendor_name"  required  placeholder="Vendor Name"/> </div></div>
...
<div class='col s12 m6 l6'><div class="input-field col s5 left leftspace">
<textarea name="ven_add" id="ven_add" value="" placeholder="Vendor Address" class="resetThis"/></textarea>
<input type="hidden" name="ven_id" id="ven_id" placeholder="vendor-id" class="resetThis" /><br /></div></div>
...
<div class="input-field col s2"> 
  <input type="text" name="ven_contactperson" id="ven_contactperson"  placeholder="Contact Person" class="resetThis"/></div>
  </center>
  </div>
</div>
...
We are pleased to place the Purchase order as per the details mentioned below for our Project</div> <div class="col s2 left"><select name="project_name" id="project_name" onChange="projectlist(this.value)" required="required" class="resetThis">
<?php
require('connect.php');
$result = mysql_query("SELECT distinct project_name FROM project_details",$conn);
 ...
 <select name="blockname" id="blockname" required="required" class="resetThis">
...
<tr class="item-row"><td><input type="checkbox" id="selecttd1"  class="case" /><label for="selecttd1"></label></td>
<td><div class="input-field col s8 "> 
<input data-type="pro_name" name="itemDesc[]" class="autocomplete_txt itemDesc resetThis"  id="itemDesc_1"  type="text"  required  placeholder="Description"/></div></td>
<td><div class="input-field col s8 "><input name="cat_name[]"  class="resetThis" id="cat_name_1" type="hidden"/>
                      <input name="sub_catname[]"  class="resetThis" id="sub_catname_1" type="hidden"/>
                     <input name="brand[]"   id="brand_1" tabindex="1" type="hidden"  />
                      <input name="product_code[]"  class="resetThis" id="product_code_1"  type="hidden" data-type="product_code" />
                       <input name="size[]" class="resetThis" id="size_1" tabindex="1" type="hidden"  />
                
                    <input name="itemQty[]"  class="changesNo resetThis" id="itemQty_1" tabindex="1" type="number" required placeholder="Quantity" nkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" />
                     <input name="units"  class="units resetThis" id="units_1" tabindex="1" type="number" required placeholder="units" /></div>
                 </td>
<td><div class="input-field col s8 "><input name="itemPrice[]"  class="changesNo resetThis" id="itemPrice_1" type="number" required placeholder="Price" nkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" /></div></td>
<td><div class="input-field col s8 "><input name="itemVat[]" class="changesNo resetThis " id="itemVat_1" type="number"  required placeholder="Vat" nkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" /></div></td>
<td><div class="input-field col s8 "><input name="itemLineTotal[]" class="totalLinePrice resetThis" id="itemLineTotal_1" readonly="readonly" type="number" placeholder="Total" nkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" /></div></td>
</tr>


<tr>
<td class='white'><button class="btn btn-success addmore" type="button">+ Add</button></td>
<td  class='white'><button class="btn btn-danger delete" type="button">- Delete</button></td>
<td class='white'></td>
<td class='white'></td>
<td class='cyan white-text'>Grand Total</td>
<td class='cyan strong white-text'><div class="input-field col s8 "><input type="number" readonly class="resetThis" id="subTotal" name="subTotal" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placeholder="Total"></div></td>
</tr>
</tbody>
</table>
</div>
