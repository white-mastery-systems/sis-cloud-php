  ...
  <div id="main">
    ...
    <div class="wrapper">
	 ...
	 ?>   
      ...
      <section id="content">
       <!-- Page disp Area -->     
       <form method="post" id="fm" action="purchase_update.php"> 
<div id='breadcrumbs-wrapper' class='grey lighten-3'>
      <div class='container-title'>
             <div class='row'>
               <div class='col s12 m12 l12'>
                 <h5 class='breadcrumbs-title'>Purchase Order Edit</h5>
...
html += '<td><div class="input-field col s8 "><input type="text" name="itemLineTotal[]" id="itemLineTotal_'+i+'" class="totalLinePrice_st resetThis" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required="required" placeholder="Total" ></div></td>';
html += '</tr>';
$('#itemsTable').append(html);
i++;
});
...
html += '<td><div class="input-field col s8 "><input type="text" name="itemPrice[]" id="itemPrice_'+i+'" class="changesNo1 resetThis" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required="required" placeholder="Price"></div></td>';
html += '<td><div class="input-field col s8 "><input type="text" name="itemLineTotal[]" id="itemLineTotal_'+i+'" class="totalLinePrice_s resetThis" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required="required" placeholder="Total" ></div></td>';
html += '</tr>';
$('#itemsTable').append(html);
i++;
