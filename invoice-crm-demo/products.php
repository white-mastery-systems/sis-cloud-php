...
<span id="prod" class="right rightspace navigationsbuttons"> <a href="order.php" class="btn btn-success cyan" type="button">Purchase Orders</a> <a href="vendor.php" class="btn btn-success cyan" type="button">Vendors</a> </span>
<h5 id="prod" class="breadcrumbs-title">Products</h5>
<div id="prod" class='left leftspace navigations'><a href="order.php" class='btn-floating btn-large waves-effect waves-light pink'><i class='material-icons'>arrow_back</i></a></div>
<div class='right rightspace navigations' id="pro-btn"><span><a class="btn-floating btn-large waves-effect waves-light pink" title="Delete" id="del_all" style="display:none" > <i class="material-icons" title="Cancel">delete</i></a></span> 
<span><a class="btn-floating btn-large waves-effect waves-light pink" title="Add Vendor" onClick="fun_add()"><i class="material-icons" title="add">add</i></a></span> </div>
</div>
</div>
</div>
</div>
     ...
     <div class="fitem">
      ...
      <option value="standard">standard</option>
        ...
        <div class="fitem">
				...
				<input type="text" name="pro_name" id="pro_name1" value="" class="">
                <input type="hidden" name="action" id="action" value="add" class="">
			</div>
		<div class="fitem">
				 <label>Code </label>
				 <input type="text" name="pro_code" id="pro_code1" value=""class="">
			 </div>
             <div class="fitem csize" style="display:none">
				 <label>Size </label>
				 <input type="text" name="pro_size" id="pro_size1" value="" class="">
			 </div>
            <div class="fitem cprice" style="display:none">
				 <label>Price </label>
				 <input type="text" name="pro_price" id="pro_price1" value="" class="">
			 </div>
              <div class="fitem steel" style="display:none">
				 <label>Details </label>
				 <input type="text" name="pro_details" id="pro_details1" value="" class="">
			 </div>
              
                <div class="fitem windisp">
				 <label>Width</label>
				 <input type="text" name="pro_width" id="pro_width1" value="" class="">
			 </div>
             <div class="fitem windisp">
				 <label>Height</label>
				 <input type="text" name="pro_height" id="pro_height1" value="" class="">
			 </div>	
			 <div class="fitem">
				 <label>Vat</label>
				 <input type="text" name="pro_vat" id="pro_vat1" value="" class="">
			 </div>
              <div class="fitem windisp">
				 <label>ED</label>
				 <input type="text" name="pro_ed" id="pro_ed1" value="" class="">
			 </div>
              <div class="fitem windisp">
				 <label>ST</label>
				 <input type="text" name="pro_st" id="pro_st1" value="" class="">
			 </div>
              <div class="fitem windisp">
				 <label>Transportation</label>
				 <input type="text" name="pro_tp" id="pro_tp1" value="" class="">
			 </div>
                <div class="fitem">
				 <label>Units</label>
				 <input type="text" name="pro_units" id="pro_units1" value="" class="">
			 </div>
			 
			<div class="fitem brand">
				 <label>Brand</label>
				<input type="text" name="pro_brand" id="pro_brand1" value="" class="">
			</div>
              
             <div class="fitem windisp">
				 <label>Material Cost</label>
				 <input type="text" name="pro_materialcost" id="pro_materialcost1" value="" class="">
			 </div>
             <div class="fitem windisp">
				 <label>Installation Cost</label>
				 <input type="text" name="pro_icost" id="pro_icost" value="" class="">
			 </div>
        <div class="fitem subcat">
				 <label>Sub Category</label>
				 <input type="text" name="pro_subcat" id="pro_subcat1" value=""class="">
			 </div>
            <div class="fitem">
				 <label>Category</label>
				 <input type="text" name="pro_category" id="pro_category1" value="" class="">
			 </div>
           
           <div align="right" >           
<button type='submit' class='btn-floating btn-medium waves-effect waves-light pink' title='submit'><i class='material-icons small'>done</i></button>  <button type='button' id="clear" class='btn-floating btn-medium waves-effect waves-light pink' onClick="popupclose()"><i class='material-icons small'>clear</i></button></div>
			   </form>
 ...
 <div class="modal fade" id="overlayedit" style="">
  ...
  <form id="fm" class="fm-edit" novalidate="novalidate" >
        ...
        <div class="fitem common" style="display:none">
				<label>Product Name</label>
				<input type="text" name="pro_name" id="pro_name" value="" class="">
		...
		<div class="fitem common" style="display:none">
				 <label>Code </label>
				 <input type="text" name="pro_code" id="pro_code" class="">
			 </div>
             <div class="fitem csize" style="display:none">
				 <label>Size </label>
				 <input type="text" name="pro_size" id="pro_size"  class="">
			 </div>
            <div class="fitem cprice" style="display:none">
				 <label>Price </label>
				 <input type="text" name="pro_price" id="pro_price"  class="">
			 </div>
              <div class="fitem steel" style="display:none">
				 <label>Details </label>
				 <input type="text" name="pro_details" id="pro_details"  class="">
			 </div>

                <div class="fitem windisp" style="display:none">
				 <label>Width</label>
				 <input type="text" name="pro_width" id="pro_width" class="">
			 </div>
             <div class="fitem windisp" style="display:none">
				 <label>Height</label>
				 <input type="text" name="pro_height" id="pro_height" class="">
			 </div>	
			 <div class="fitem common" style="display:none">
				 <label>Vat</label>
				 <input type="text" name="pro_vat" id="pro_vat"  class="">
			 </div>
              <div class="fitem windisp" style="display:none">
				 <label>ED</label>
				 <input type="text" name="pro_ed" id="pro_ed" class="">
			 </div> 
              <div class="fitem windisp" style="display:none">
				 <label>ST</label>
				 <input type="text" name="pro_st" id="pro_st"  class="">
			 </div>
              <div class="fitem windisp" style="display:none">
				 <label>Transportation</label>
				 <input type="text" name="pro_tp" id="pro_tp"  class="">
			 </div>
                <div class="fitem common" style="display:none" >
				 <label>Units</label>
				 <input type="text" name="pro_units" id="pro_units"  class="">
			 </div>
			 
			<div class="fitem common" style="display:none" >
				 <label>Brand</label>
				<input type="text" name="pro_brand" id="pro_brand"  class="">
			</div>
              
             <div class="fitem windisp" style="display:none" >
				 <label>Material Cost</label>
				 <input type="text" name="pro_materialcost" id="pro_materialcost"  class="">
			 </div>
             <div class="fitem windisp" style="display:none">
				 <label>Installation Cost</label>
				 <input type="text" name="pro_icost" id="pro_icost"  class="">
			 </div>
        <div class="fitem subcat common" style="display:none">
				 <label>Sub Category</label>
				 <input type="text" name="pro_subcat" id="pro_subcat" class="">
			 </div>
            <div class="fitem common" style="display:none">
				 <label>Category</label>
				 <input type="text" name="pro_category" id="pro_category" class="">
			 </div>
   
        <div align="right">       
      <button type='submit' class='btn-floating btn-medium waves-effect waves-light  pink' title='submit'><i class='material-icons small'>done</i></button>  <button type='button' id="clear" class='btn-floating btn-medium waves-effect waves-light  pink' onClick="popupclose()"><i class='material-icons small'>clear</i></button>
</div>
			   </form>
