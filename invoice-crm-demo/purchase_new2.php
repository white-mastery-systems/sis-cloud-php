...
<thead>
					...
					<tbody>
						<tr>
							<td><input type="checkbox" id="selecttd1"  class="case" /><label for="selecttd1"></label></td>
							
							<td><div class="input-field col s8 "><input type="text" data-type="pro_name" name="itemDesc[]" id="itemDesc_1" class=" autocomplete_txt" autocomplete="off"></div></td>
							<td><div class="input-field col s8 "><input type="number" name="itemQty[]" id="itemQty_1" class=" changesNo" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">  <input name="units"  class="units resetThis" id="units_1" tabindex="1" type="hidden" required placeholder="units" /></div></td>
							<td><div class="input-field col s8 "><input type="number" name="itemPrice[]" id="itemPrice_1" class=" changesNo" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
                            <td><div class="input-field col s8 "><input type="number" name="itemVat[]" id="itemVat_1" class=" changesNo" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
							<td><div class="input-field col s8 "><input type="number" name="itemLineTotal[]" id="itemLineTotal_1" class=" totalLinePrice" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></div></td>
						</tr>
					</tbody>
                    </table>
<table class='table table-full'>
<tr>
<td class='white'><button class="btn btn-success addmore" type="button">+ Add</button> <button class="btn btn-danger delete" type="button">- Delete</button></td>
<td  class='white'></td>
<td class='white'></td>
<td class='white'></td>
