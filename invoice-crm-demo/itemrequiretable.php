        ...
        <div class="navbar-fixed">
            <nav class="cyan">
                <div class="nav-wrapper">                    
                    ...
                    <ul class="left">                      
<li><h1 class="logo-wrapper"><a href="#" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1></li></ul>
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        ...
                        <li><a href="javascript:void(0);" class="waves-effect waves-block waves-light"><i class="mdi-navigation-apps"></i></a></li>                        
...
<button type='submit' class='btn-floating btn-medium waves-effect waves-light' title='submit'><i class='material-icons small'>done</i></button>  <button type='button' id="clear" class='btn-floating btn-medium waves-effect waves-light' onClick="popupclose()"><i class='material-icons small'>clear</i></button></div>
 ...
 <div class="modal fade" id="overlayedit" style="">
  ...
  <form id="fm" method="get" novalidate="novalidate" class="fm-edit">
		...
		<div class="fitem common" style="display:none">
				 <label>Code </label>
				 <input name="pro_code" id="pro_code" value=""class="textbox">
			 </div>
             <div class="fitem csize" style="display:none">
				 <label>Size </label>
				 <input name="pro_size" id="pro_size" value="" class="textbox">
			 </div>
            <div class="fitem cprice" style="display:none">
				 <label>Price </label>
				 <input name="pro_price" id="pro_price" value="" class="textbox">
			 </div>
              <div class="fitem steel" style="display:none">
				 <label>Details </label>
				 <input name="pro_details" id="pro_details" value="" class="textbox">
			 </div>

                <div class="fitem windisp" style="display:none">
				 <label>Width</label>
				 <input name="pro_width" id="pro_width" value=""class="textbox">
			 </div>
             <div class="fitem windisp" style="display:none">
				 <label>Height</label>
				 <input name="pro_height" id="pro_height" value=""class="textbox">
			 </div>	
			 <div class="fitem common" style="display:none">
				 <label>Vat</label>
				 <input name="pro_vat" id="pro_vat" value="" class="textbox">
			 </div>
              <div class="fitem windisp" style="display:none">
				 <label>ED</label>
				 <input name="pro_ed" id="pro_ed" value="" class="textbox">
			 </div> 
              <div class="fitem windisp" style="display:none">
				 <label>ST</label>
				 <input name="pro_st" id="pro_st" value="" class="textbox">
			 </div>
              <div class="fitem windisp" style="display:none">
				 <label>Transportation</label>
				 <input name="pro_tp" id="pro_tp" value="" class="textbox">
			 </div>
                <div class="fitem common" style="display:none" >
				 <label>Units</label>
				 <input name="pro_units" id="pro_units" value="" class="textbox">
			 </div>
			 
			<div class="fitem common" style="display:none" >
				 <label>Brand</label>
				<input name="pro_brand" id="pro_brand" value="" class="textbox">
			</div>
              
             <div class="fitem windisp" style="display:none" >
				 <label>Material Cost</label>
				 <input name="pro_materialcost" id="pro_materialcost" value="" class="textbox">
			 </div>
             <div class="fitem windisp" style="display:none">
				 <label>Installation Cost</label>
				 <input name="pro_icost" id="pro_icost" value="" class="textbox">
        ...
        <div class="fitem subcat common" style="display:none">
				 <label>Sub Category</label>
				 <input name="pro_subcat" id="pro_subcat" value=""class="textbox">
			 </div>
            <div class="fitem common" style="display:none">
				 <label>Category</label>
				 <input name="pro_category" id="pro_category" value="" class="textbox">
			 </div>
...
<!--   Delete temp -->
 ...
 <div class="modal fade" id="overlaydelete" style="">
  ...
  <form id="fm" method="post" novalidate="novalidate" class="fm-delete">
        <div class="fitem">
