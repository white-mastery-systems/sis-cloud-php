...
$html.= "<td class='cyan white-text'  colspan='2'  align='center' style='border-collapse: collapse;font-size:18px; border:solid 1px #000;padding:5px'><b>Transport</b></td>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px; font-size:18px; font-family:cambria' align='right'><b><span><img src='images/rupee.jpg' /> </span> ".formatInIndianStyle($tpamount)."</b></td>";
$html.= "</tr>";        
   }
    else
    {
...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;width:100px; height:28px' align='center' valign='middle'><b>Size</b></th>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'><b>Vat</b> &nbsp; <b>".$tax."%</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>".formatInIndianStyle($taxc)."</td>";
$html.= "</tr>";
$html.= "<tr>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>  <span><img src='images/rupee.jpg' /></span>".formatInIndianStyle($subtotal)."</td>";
$html.= "</tr>";
$html.= "</tbody>";
$html.=  "</table>";
