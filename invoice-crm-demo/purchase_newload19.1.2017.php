...
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='subTotal' name='subTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Grand Total' required /></div></td>";
echo "</tr>";
echo "</table></div>";
echo "</div>";
...
echo "<div class='row leftspace'>
<div class='col12 s12 m6 l3 cyan'>
<div class='col s1'  style='width:auto; margin:0 8px 0 0px'>Ref : </div><div class='input-field col s2 left' style='margin:0 0px 0 10px'><input type='text' name='refno' id='refno' class='validate resetThis' placeholder='Ref No'/></div> <div  class='col s4' style='width:auto; margin:0 10px 0 8px'> - Amended Qty Without Glass Dated</div> <div class='input-field col s2 left'> <input type='text' name='refdate' id='refdate' placeholder='Ref Date' class='validate resetThis' class='resetThis'  /> </div>";
echo "<div class='col s12 m6 l6 right rightspace'><div class='input-field col s8 left leftspace'>&nbsp;</div></div>
</div>
</div>";
echo "<div class='row  leftspace'>
...
echo "<td class='white'></td>";
echo "<td class='cyan white-text'>Grand Total</td>";
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='subTotal' name='subTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Total' required='required' placeholder='Grand total'/></div></td>";
echo "</tr>";
echo "</table></div>";
echo "</div>";
echo "<div class='invoice-footer'>";
...
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text'  readonly class='resetThis' id='subTotal' name='subTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Subtotal' required='required' /></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'></td>";
echo "<td  class='white'></td>";
