...
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action :Purchase Duplicate Page";
writeToLogFile($msg);
//$lognme ;
      ...
      <div class='container-title'>
             <div class='row'>
               <div class='col s12 m12 l12'>
                 <h5 class='breadcrumbs-title'>Purchase Order duplicate</h5>
         ...
         <input type="hidden" name="po_no1" id='po_no1' value="<?php echo $po_no; ?>" />
		   <input type="hidden" name="po_year1" id='po_year1' value="<?php echo $po_year; ?>" />
        <div class='container'>
       <!-- Disp Area -->
...
<script type="text/javascript" language="javascript">
	 ...
	 function changestatus1()
  {
    ...
    var dataString="&po_no="+po_no+"&po_year="+po_year;
      $.ajax({
      url: "purchase_duplicateload.php",
      type: "POST",
      data: dataString,
...
$(".addmore1").on('click',function(){
	...
	html += '<td><div class="input-field col s8 "><input type="text" name="itemQty[]" id="itemQty_'+i+'" class="changesNo1 resetThis" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" placeholder="QTY"><input class="units resetThis" id="units_'+i+'" name="units[]" tabindex="1" type="hidden" required placeholder="units" /></div></td>';
	html += '<td><div class="input-field col s8"><input name="units[]"  class="units resetThis" id="units_1" tabindex="1" type="text" required placeholder="units" /></div></td>'
...
html += '<td><div class="input-field col s8 "><input type="text" name="itemQty[]" id="itemQty_'+i+'" class="changesNo1 resetThis" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required="required" placeholder="CFT" readonly>  <input class="units resetThis" id="units_'+i+'" name="units[]" tabindex="1" type="hidden" required placeholder="units" /></div></td>';
