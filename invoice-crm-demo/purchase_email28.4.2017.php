...
$mail->IsHTML(true);
$mail->Subject= $esub;
$mail->Body    = $email_content.'<div><br><img src="http://www.sis.in/Signature_New/anisa.jpg"></div>';
...
{
  echo "Mail sent!";
 $sqlsent = "INSERT INTO sentitems(fname,femail,temail,tname,subject,tarea,sdate,stime,po_no,ven_compname,tarea1,po_year) VALUES ('$fname','$femail','$email','$ven_contactperson','$esub','$email_content','$sdate','$stime','$po_no','$ven_compname','$email_content1','$po_year')";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;padding-left:5px ; ' align='left' valign='middle'>" .$productname. "</td>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'> " .formatInIndianStyle($ratesperproduct). "</td>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; ' align='center' valign='middle'><b>vat</b></td>";
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px ' align='right' valign='middle'>".$tax."%</td>";
$html.= "</tr>";
$html.= "<tr>";
