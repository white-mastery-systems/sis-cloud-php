...
echo '<div class="content" style="width:100%"><div style="width:85%; position:relative; float:left;height:auto; line-height:160%">'.$row_bal["pro_name"].'</div><div style="width:15%; position:relative;  float:left; height:auto; line-height:160%"><i class="material-icons" style="height:35px; line-height:35px">cancel</i></div></div>';
					...
					<div class="modal-body">
						...
						<div class="col s12 m12 l12" id="add-content">
							...
							<form id="fm" method="get" novalidate="novalidate" class="fm-add">
								...
								<div align="right">
									<button type='submit' class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" title='submit'><i class='material-icons small'>done</i></button>
									<button type='button' id="clear" style="background-color:#ff4081" class='btn-floating btn-medium waves-effect waves-light' onClick="popupclose()"><i class='material-icons small'>clear</i></button>
								</div>
							</form>
					...
					<div class="modal-body">
						...
						<div class="col s12 m12 l12" id="add-content">
							...
							<form id="fm" method="get" novalidate="novalidate" class="fm-addvendor">
								...
								<div align="right">
									<button type='submit' class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" title='submit'><i class='material-icons small'>done</i></button>
									<button type='button' id="clear" class='btn-floating btn-medium waves-effect waves-light' style="background-color:#ff4081" onClick="popupclose()"><i class='material-icons small'>clear</i></button>
								</div>
							</form>
		...
		<script type="text/javascript" language="javascript">
			function tablesorter() {
				$(function () {
					...
					// Delete temp
					$("#itemsTable").on("click", ".use-delete", function () {
	...
	**/
				...
				$('#itemsTable tbody').on('click', 'input[type="checkbox"]', function () {
					...
					$("#itemsTable").on("click", ".use-delete1", function () {
...
var dataTable = $('#itemsTable').DataTable({
					...
					, "serverSide": true
					, 'ajax': {
						url: "ordersamp_load.php?action="+typeval, // json datasource		
