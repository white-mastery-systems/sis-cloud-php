...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:360px; font-siz:13px; font-family:cambria' align='left'><b>Description</b></th>";
...
$html.= "<th style='border-collapse: collapse; border:solid 1px #000;  padding:5px;width:140px; font-siz:13px; font-family:cambria' align='right' ><b>Total  in <span><img src='images/rupee.jpg' /> </span> </b></th>";
$html.= "</tr>";
$html.= "</thead>";
$html.= "<tbody>";
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-siz:13px; font-family:cambria' align='center'  > " .formatInIndianStyle($ratesperproduct). "</td>";
if($inclusive != '0')
{
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000;  padding:5px; font-siz:13px; font-family:cambria' align='right' > " .formatInIndianStyle($Amount). "</td>";
$html.= "</tr>";
 }
...
$html.= "<td style='border-collapse: collapse; border:solid 1px #000; padding-right:10px; font-siz:13px; font-family:cambria' align='right'><b><span><img src='images/rupee.jpg' /> </span> ".formatInIndianStyle($subtotal )."</b></td>";
$html.= "</tr>";
$html.= "</tbody>";
$html.= "</table>";
...
<b>Deliveries 4 weeks per chute from the date of techno commercially confirm.</td>";
$html.= "</tr>";
$html.= "<tr>";
...
$html.= "<tr>";
$html.= "<td valign='top' colspan='3'>
<b>List of work will be provided by S.I.S</b></td>";
$html.= "</tr>";
$html.= "</table>";
$html.= "<table style='width:100%;font-siz:18px; font-family:cambria'>";

$html.= "<tr> <td colspan='3'>1.Provided with 2".chr(39)."(24".chr(34).") x 2".chr(39). "(24".chr(34).") space in the duct meant for chute erection.<br>2.230 V,  15 Amp power connections in the garbage room at Stilt level, for Cleaning Control Panel as chute will be terminated at that level (with MCB).<br>3.230 V, 15 Amp power at roof level for Exhaust System. (6Amp MCB)<br>4.Provided with a Gully Trap in the Garbage room connected to drainage system.</td></tr>";
$html.= "<tr>";
$html.= "<td  colspan='3'>
5.Provided with Garbage room of size 1.5Mtr x 2mtr. Minimum at Ground level just below the Chute duct.The garbage room will be totally non-ventilatroom. The room floor will be given a slope toward the gulley trap for the cleaning water & phenyl drain.</td></tr>
<tr><td  colspan='3'>2.1.5".chr(34). " water connection from overhead water tank.</td></tr>
<tr><td  colspan='3'>
6.We will provide storage of chute material, electricity & water free of cost.<br>
7.<b>Wet riser along with connections up to the fire sprinklers (ready to connect the fire sprinklers.</b></td></tr>
<tr><td  colspan='3' style='font-siz:13px; font-family:cambria'>The above price is net price inclusive of all Taxes and Transport Charges.<br><br></p></td></tr>
<tr><td  colspan='3'>
The Other terms and conditions remains the same as per your Quote.<br><br>";
$html.= "</td></tr>
<tr>";
$html.= "<td style='width:38%; font-siz:13px; font-family:cambria;line-height:200%' valign='top'>Site contact Person </td>";
$html.= "<td style='width:5%;font-siz:13px; font-family:cambria;line-height:200%'>:</td>";
$html.= "<td style='width:30%;font-siz:13px; font-family:cambria;line-height:200%'>".$contactname."</td>";
$html.= "<td  style='width:5%;font-siz:13px; font-family:cambria;line-height:200%'>:</td>";
$html.= "<td  style='width:22%;font-siz:13px; font-family:cambria;line-height:200%'>".$mobileno."</td>";
$html.= "</tr>";
$html.= "<tr>";
$html.= "<td valign='top'  style='font-siz:13px; font-family:cambria;line-height:200%'>Site address</td>";
$html.= "<td>:</td>";
$html.= "<td style='font-siz:13px; font-family:cambria;line-height:200%'><b>".$addressdispname. "</b></td>";
$html.= "<td></td>";
$html.= "<td></td>";
$html.= "<td></td>";
$html.= "</tr>";
