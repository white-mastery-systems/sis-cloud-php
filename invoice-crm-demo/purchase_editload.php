...
$projectplace = $row1['place'];    
$tp=$row1['tp'];
$tptax=$row1['tptax'];
$tpamount=$row1['tpamount'];
$tptaxafteramount=$row1['tptaxafteramount'];
...
echo "<td><div class='input-field col s8'><input type='text' name='itemtotalamount[]' id='itemtotalamount_1' class='changesNo1 resetThis' readonly autocomplete='off' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' value='".$itemtotalamount. "'  required placeholder='Amount'/></div></td>";
echo "<td><div class='input-field col s8'><input type='text' name='itemVat[]' id='itemVat_".$n."' class='changesNo1 resetThis' autocomplete='off' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' value='".$vat."' placeholder='GST' required='required' /></div></td>";
echo "<td><div class='input-field col s8'><input type='text' name='itemVatamount[]' id='itemVatamount_1' value='".$vatamount."' class='resetThis changesNo1' autocomplete='off' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required placeholder='GST Amount' readonly /></div></td>";
...
echo "<td class='white'></td>";
echo "<td class='white'></td>";
echo "<td class='cyan white-text'>SUB TOTAL</td>";
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='subTotal1' name='subTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Sub Total' value='".$subtotal."' required style='border-bottom:1px solid #fff; color:#fff; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";  
...
echo "<td class='white'></td>";
echo "<td class='white'></td>";
echo "<td class='white'>Loading and Unloading Transport</td>";
echo "<td class=''><div class='input-field col s8'><input type='text' class='resetThis' id='tp2' name='tp' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Transport Amount'  value='".$tp."' required style='border-bottom:1px solid #ccc; color:#000; text-transform:uppercase; margin: 0 0 5px 0;' />   <input type='hidden' class='resetThis' id='transportAmount_s' name='transportAmount_s' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Transport Amount' value='".$tpamount."' required style='border-bottom:1px solid #ccc; color:#000; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'></td>";
echo "<td  class='white'> </td>";
echo "<td class='white'></td>";
echo "<td class='white'></td>";
echo "<td class='white'>Transport TAX</td>";
echo "<td class=''><div class='input-field col s8'><input type='text' class='resetThis' id='tptax2' name='tptax' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Transport TAX' value='".$tptax."'required style='border-bottom:1px solid #ccc; color:#000; text-transform:uppercase; margin: 0 0 5px 0;' />   <input type='hidden' class='resetThis' id='transporttaxAmount_s' name='transporttaxAmount_s' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Transporttax Amount' value='".$tptaxafteramount."' required style='border-bottom:1px solid #ccc; color:#000; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'><button class='btn btn-success addmore1' type='button'>+ Add</button> <button class='btn btn-danger delete1' type='button'>- Delete</button> &nbsp; <input type='checkbox' name='tstatus' id='tstatus'  class=''  value='0' /><label for='tstatus'>Transportation </label></td>";
echo "<td  class='white'> </td>";
echo "<td class='white'></td>";
echo "<td class='white'></td>";
echo "<td class='cyan white-text'>GRAND TOTAL</td>";
echo "<td class='cyan strong white-text'><div class='input-field col s8 '><input type='text' readonly class='resetThis' id='grandTotals' name='grandTotal' onKeyPress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' placeholder='Grand Total' value='".$grandtotal."' required style='border-bottom:1px solid #fff; color:#fff; text-transform:uppercase; margin: 0 0 5px 0;' /></div></td>";
echo "</tr>";
...
echo "</span></div>";
echo "<div class='row'><div class='col s2'>Our GSTIN </div> <div class='input-field col s2 left'><input type='text' name='ogstin' id='ogstin'  class='resetThis' style='width:100%' placeholder='Our GSTIN' readonly required value='".$ogstin."' /> </div></div>";	
echo "<div class='row'><div class='col s2'>Party GSTIN</div><div class='input-field col s2 left'><input type='text' name='pgstin' id='pgstin'  class='resetThis' style='width:100%' placeholder='Party GSTIN' required value='".$pgstin."' /> </div></div>";
echo "<div class='row'><div class='col s2'>Payment </div> <div class='input-field col s2 left'><input type='text' name='payment' id='payment'  class='resetThis' placeholder='Payment'  required  value='".$payment."' /> </div> </div>";
echo "<div class='row'><div class='col s2'>Delivery</div><div class='input-field col s2 left'><input type='text' name='place' id='place'   style='width:100%' placeholder='Place' class='resetThis' required value='".$place."' /></div></div>";
echo "<div class='row'><div class='col s2'>Loading & Transport</div><div class='resetThis input-field col s2 left'><input type='text' name='vat_o' id='vat_o'   style='width:100%'  placeholder='VAT'  class='resetThis' value='".$vat_o."' /></div></div>";
echo "<div class='row'><b><div class='col s2'>Please Supply by</div>   <div class='input-field col s2  date form_date'> <input size='16' type='text' id='ddate' name='ddate' placeholder='Delivery Date' value='".$ddate."'><span class='add-on'><i class='icon-remove'></i></span><span class='add-on'><i class='icon-th'></i></span> </div><div class='col s1  textaligncenter'>at our</div><div class='col s2'><input type='text' name='place1' id='place1'  class='resetThis' style='width:100%' required placeholder='Place'  value='".$place."' /> </div> <div class='col s1 textaligncenter'>Site</div></b></div>";
echo "<div class='row'><div class='col s12'><b>Note: Kindly Attach Copy of the PO Along with your Invoice for Payment Purpose.</b></div></div>";	
echo "<div class='row'><b> <div class='col s2'>Site contact Person </div><div class='input-field col s2 left'><input type='text' name='contactname' id='contactname'  class='resetThis' style='width:100%' placeholder='Site Person'  value='".$contactname."' required /></div><div class='col s1 mob-pad'>Mobile :</div>     <div class='input-field col s2 left'><input type='text' name='mobilno' id='mobilno'  class='resetThis' placeholder='Mobile No' value='".$mobileno."'  required/></div> </b></div>
<div class='row'><div class='input-field col s2'><b>Site address </b></div>";
echo "<div class='input-field col s2 left'><b><input type='text' name='projectname' id='projectname'  class='resetThis' style='width:100%; font-weight:bold' placeholder='Project Name' readonly required  value='".$project_name."'/></b></div></div>";
echo "<div class='row'><div class='input-field col s4 left'><textarea name='address' id='address' value='resetThis' class='resetThis' readonly placeholder='address' style='height:80px' required>".$address."</textarea><br />";
echo "<input type='hidden' name='project_id' id='project_id'  value='".$project_id."' class='resetThis' style='width:100%' required /></div></div></p></div>";
...
echo "<div class='row'><div class='col s2 right'>  <button type='submit' class='btn-floating btn-large waves-effect waves-light pink' title='submit'><i class='material-icons medium'>done</i>></button> <a class='btn-floating btn-large waves-effect waves-light pink' title='Cancel' id='clear'><i class='material-icons medium'>clear</i></a></div></div>";
     echo "<input type='hidden' name='city' id='city' style='width:auto' placeholder='city' readonly  class='resetThis'  value='".$projectplace."' />"; 
}
else if($type == "upvc")
{
echo "<div class='row topspacelarge' align='center'>";
...
echo "<td class='strong'><div class='input-field col s8 '><input type='text' class='resetThis' id='vatdr' name='vat' placeholder='vat' onkeypress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' required='required' value='".$tax."'/> </div></td>";
echo "</tr>";
...
echo "<td class='white'></td>";
echo "<td class='white'></td>";
echo "<td class=''>GST Amount</td>";
echo "<td class='strong'><div class='input-field col s8 '><input type='text' class='resetThis' id='taxAmountdr' placeholder='Tax'  onkeypress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;'  value='".$gstamount."'></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='white'></td>";
echo "<td  class='white'></td>";
