...
{
       $html.= "<tr>";                       
                         $html.= "<td colspan='2' style='border:1px solid #000; padding:5px;  font-size:16px;'>Taxable Value(Rs.)</td>";
                         $html.= "<td style='border:1px solid #000; padding:5px;  font-size:16px;' align='right'>".$taxamount."</td>";
