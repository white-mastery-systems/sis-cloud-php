...
<div id="notificationFooter"><a href="#">See All</a></div>
  ...
  <div id="main">
    ...
    <div class="wrapper">
	 ...
	 ?>   
        ...
        <a href="#" data-activates="slide-out" class="sidebar-collapse btn-floating shadow-menu btn-medium waves-effect waves-light hide-on-large-only cyan"><i class="material-icons">menu</i></a>
      </aside>
  ...
  <span class="right navigations1"><a class="mfb-component__button--main" title="Delete" id="del_all" style="display:none"> <i class=" mfb-component__main-icon--resting material-icons" title="Cancel">delete</i></a></span> 
        ...
        <div class="row" style="background-color:#fff;">
          ...
          <div class="section topspace" id="ord">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 ...
 <!--<form id="search" action="#" method="post">
                ...
                <div id="input"><input type="search" name="search-terms" id="search-terms" placeholder="Enter search terms..."></div>
            </form>    --> 
 ...
 <div class="modal fade" id="overlay" style="">
  <div class="modal-dialog" style="width:800px;">
    <div class="modal-content">
      ...
      <div style="width:800px;" id="disp-content">
