...
$product_code=$_POST['product_code'][$row];
}
...
$sql1 = "INSERT INTO purchase_master(po_no,po_date,project_id,ven_id,subtotal,ddate,ed,tax,st,transportation,status,project_name,Block,description,gt,gt1,type,refno,refdate,stotal,basictotal,itotal,folder,payment,subject,contactname,mobileno,tpwords)VALUES($po_no,'$po_date',$project_id,'$ven_compname',$totalAftertax,'$ddate','$ed','$vat','$st','$transportation','open','$project_name','$blockname','$desc','$gt','$gt1','$type','$refno','$refdate','$subTotal','$basictotal','$itotal','$folder','$payment','$subject','$contactname','$mobileno','$tpwords')";
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
}
...
$product_code=mysql_real_escape_string($_POST['product_code'][$row]);
if($inclusive == '0')
{
	$itemVat = '0';
}
...
$desc = mysql_real_escape_string($desc);
$sql1 = "INSERT INTO purchase_master(po_no,po_date,project_id,ven_id,subtotal,ddate,vat,status,project_name,Block,description,type,refno,refdate,folder,tax,stotal,payment,subject,contactname,mobileno,tpwords) VALUES($po_no,'$po_date',$project_id,'$ven_compname','$totalAftertax','$ddate','$tax','open','$project_name','$blockname','$desc','$type','$refno','$refdate','$folder','$vat','$subTotal','$payment','$subject','$contactname','$mobileno','$tpwords')";
echo $sql1;
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
