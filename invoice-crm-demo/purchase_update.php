...
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,block,status,po_no,stock,stock_balance,stk_received,istatus,gst_status) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','$blockname','invoiceraised',$po_no,$itemQty,$itemQty,'0','intransit','included' )";
...
if( $itemDesc != '')
{
$sql = "update purchaseorder_tbl set product_name='$itemDesc',Po_no='$po_no',product_code='$product_code',product_qty='$itemQty',ratesperproduct='$itemPrice',Amount='$itemLineTotal',vat='$itemVat',po_date='$po_date',cat_name='$cat_name',sub_catname='$sub_catname',units='$units',status='open',project_name='$project_name',block='$blockname' , po_year='$po_year',vatamount='$itemVatamount',itemtotalamount='$itemtotalamount' WHERE Po_no ='$po_no' and po_id=$po_id and  po_year='$po_year' and gst_status='included'";
//echo $sql."Updated";
$result = mysql_query($sql,$conn);
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
$result3 = mysql_query($sql3,$conn);	
...
//echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,block,status,po_no,stock,stock_balance,details,stk_received,istatus and gst_status) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','$blockname','invoiceraised',$po_no,$itemQty,$itemQty,'$details','0','intransit','included')";
$result4 = mysql_query($sql4,$conn);
//echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
//echo $query;
...
$desc = mysql_real_escape_string($desc);
$sql1 = "UPDATE purchase_master SET po_date='$po_date',project_id='$project_id',ven_id='$ven_compname',subtotal='$subTotal',ddate='$ddate',status='open',project_name='$project_name',Block='$blockname',description='$desc',type='$type',refno='$refno',refdate='$refdate',folder='$folder',payment='$payment',subject='$subject',contactname='$contactname',mobileno='$mobileno',vat='$tax',inclusive='$inclusive', tpwords='$tpwords', po_year='$po_year', place='$city' ,ogstin='$ogstin',pgstin='$pgstin' WHERE po_no='$po_no' and po_year='$po_year' and gst_status='included'";
//echo $sql1;
$result1 = mysql_query($sql1,$conn);
$msg = "IP: " . $ip . " TIME: " . $time . " User: " .$_SESSION['st_username'].  " USERAGENT: " .$userAgent. "Action : PO-NO".$po_no."Inserted";
writeToLogFile($msg);
