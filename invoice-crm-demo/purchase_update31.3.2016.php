...
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,block,status,po_no,stock,stock_balance,stk_received,istatus) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','$block','invoiceraised',$po_no,$itemQty,$itemQty,'0','intransit' )";
...
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
$result3 = mysql_query($sql3,$conn);	
$sql4 = "update  stocklist set pro_name='$itemDesc',product_code='$product_code',cat_name='$cat_name',sub_catname='$sub_catname',price='$itemPrice',brand='$brand',project_name='$project_name',block='$block',status='invoiceraised',po_no='$po_no',stock='$itemQty',stock_balance='$itemQty',istatus='intransit' where WHERE po_no=$po_no and pro_name='$itemDesc' ";
$result4 = mysql_query($sql4,$conn);
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
$query_run = mysql_query($query,$conn); 	
while ($req_row = mysql_fetch_array($query_run)) 
...
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "UPDATE stocklist SET pro_name='$itemDesc',product_code='$itemCode',itemHeight='$itemHeight',itemWidth='$itemWidth',itemBasic_m='$itemBasic_m',item_totali,brand='$itemBrand',project_name='$project_name',block='$block',status='invoiceraised',stock='$itemQty',stock_balance='$itemQty',stk_received='0', istatus='intransit' WHERE po_no=$po_no and product_code='$itemCode'";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_code='$itemCode' and project_name='$project_name'";
echo $query;
...
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,size,brand,project_name,block,status,po_no,stock,stock_balance,stk_received,istatus) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$size','$brand','$project_name','$block','invoiceraised',$po_no,$itemQtyd,$itemQtyd,'0','intransit')";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
echo $query;
...
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "UPDATE  stocklist SET pro_name='$itemDesc',product_code='$product_code',cat_name='$cat_name',sub_catname='$sub_catname',price='$itemPrice',size='$size',brand='$brand',project_name='$project_name',block='$block',status='invoiceraised',stock='$itemQtyd',stock_balance='$itemQtyd',stk_received='0', istatus='intransit' WHERE po_no=$po_no and product_code='$product_code'";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
echo $query;
...
echo $sql3;
$result3 = mysql_query($sql3,$conn);
$sql4 = "INSERT INTO stocklist(pro_name,product_code,cat_name,sub_catname,price,brand,project_name,block,status,po_no,stock,stock_balance,details,stk_received,istatus) VALUES ('$itemDesc','$product_code','$cat_name','$sub_catname','$itemPrice','$brand','$project_name','$block','invoiceraised',$po_no,$itemQty,$itemQty,'$details','0','intransit')";
$result4 = mysql_query($sql4,$conn);
echo $sql4;
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
echo $query;
...
$sql3 = "update productlist set Product_price='$itemPrice' where pro_name='$itemDesc' and category_name='$cat_name' and sub_catname='$sub_catname'";
$result3 = mysql_query($sql3,$conn);
$sql4 = "UPDATE stocklist SET pro_name='$itemDesc',product_code='$product_code',cat_name='$cat_name',sub_catname='$sub_catname',price='$itemPrice',brand='$brand',project_name='$project_name',block='$block',status='invoiceraised',stock='$itemQty',stock_balance='$itemQty',details='$details',stk_received='0',istatus='intransit' WHERE po_no=$po_no and pro_name='$itemDesc'";
$result4 = mysql_query($sql4,$conn);
$query = "select * from requirementtable where product_name='$itemDesc' and cat_name='$cat_name' and sub_catname='$sub_catname'";
$query_run = mysql_query($query,$conn); 	
while ($req_row = mysql_fetch_array($query_run)) 
